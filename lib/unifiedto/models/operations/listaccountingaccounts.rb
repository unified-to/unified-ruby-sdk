...
module UnifiedRubySDK
  module Operations
    ...
    class ListAccountingAccountsRequest < UnifiedRubySDK::Utils::FieldAugmented
      extend T::Sig
    ...
    class ListAccountingAccountsResponse < UnifiedRubySDK::Utils::FieldAugmented
      ...
      # Successful
      field :accounting_accounts, T.nilable(T::Array[Shared::AccountingAccount])


      sig { params(content_type: String, raw_response: Faraday::Response, status_code: Integer, accounting_accounts: T.nilable(T::Array[Shared::AccountingAccount])).void }
