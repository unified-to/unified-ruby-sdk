...
module UnifiedRubySDK
  module Operations
    ...
    class ListCommerceLocationsResponse < ::UnifiedRubySDK::Utils::FieldAugmented
      ...
      # Successful
      field :commerce_locations, T.nilable(T::Array[Shared::CommerceLocation])


      sig { params(content_type: String, raw_response: Faraday::Response, status_code: Integer, commerce_locations: T.nilable(T::Array[Shared::CommerceLocation])).void }
