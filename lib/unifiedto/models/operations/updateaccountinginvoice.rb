...
module OpenApiSDK
  module Operations
    ...
    class UpdateAccountingInvoiceRequest < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(connection_id: String, id: String, accounting_invoice: T.nilable(Shared::AccountingInvoice)).void }
    ...
    class UpdateAccountingInvoiceResponse < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
