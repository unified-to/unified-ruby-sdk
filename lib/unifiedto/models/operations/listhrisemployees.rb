...
module UnifiedRubySDK
  module Operations
    ...
    class ListHrisEmployeesResponse < ::UnifiedRubySDK::Utils::FieldAugmented
      ...
      # Successful
      field :hris_employees, T.nilable(T::Array[Shared::HrisEmployee])


      sig { params(content_type: String, raw_response: Faraday::Response, status_code: Integer, hris_employees: T.nilable(T::Array[Shared::HrisEmployee])).void }
