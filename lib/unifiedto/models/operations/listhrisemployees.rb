...
module OpenApiSDK
  module Operations
    ...
    class ListHrisEmployeesResponse < OpenApiSDK::Utils::FieldAugmented
      ...
      sig { params(content_type: String, status_code: Integer, hris_employees: T.nilable(T::Array[Shared::HrisEmployee]), raw_response: T.nilable(Faraday::Response)).void }
      def initialize(content_type: nil, status_code: nil, hris_employees: nil, raw_response: nil)
