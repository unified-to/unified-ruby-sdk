...
module UnifiedRubySDK
  module Operations
    ...
    class ListAccountingTaxratesRequest < UnifiedRubySDK::Utils::FieldAugmented
      extend T::Sig
    ...
    class ListAccountingTaxratesResponse < UnifiedRubySDK::Utils::FieldAugmented
      extend T::Sig
      ...
      # Successful
      field :accounting_taxrates, T.nilable(T::Array[Shared::AccountingTaxrate])


      sig { params(content_type: String, raw_response: Faraday::Response, status_code: Integer, accounting_taxrates: T.nilable(T::Array[Shared::AccountingTaxrate])).void }
      def initialize(content_type: nil, raw_response: nil, status_code: nil, accounting_taxrates: nil)
        @content_type = content_type
        @raw_response = raw_response
        @status_code = status_code
        @accounting_taxrates = accounting_taxrates
      end
    end
  end
end
