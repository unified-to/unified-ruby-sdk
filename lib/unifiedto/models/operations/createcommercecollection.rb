...
module UnifiedRubySDK
  module Operations
    ...
    class CreateCommerceCollectionRequest < ::UnifiedRubySDK::Utils::FieldAugmented
      ...
      sig { params(connection_id: String, commerce_collection: T.nilable(Shared::CommerceCollection)).void }
    ...
    class CreateCommerceCollectionResponse < ::UnifiedRubySDK::Utils::FieldAugmented
      extend T::Sig
