...
module UnifiedRubySDK
  module Operations
    ...
    class ListCommerceCollectionsResponse < ::UnifiedRubySDK::Utils::FieldAugmented
      ...
      # Successful
      field :commerce_collections, T.nilable(T::Array[Shared::CommerceCollection])


      sig { params(content_type: String, raw_response: Faraday::Response, status_code: Integer, commerce_collections: T.nilable(T::Array[Shared::CommerceCollection])).void }
