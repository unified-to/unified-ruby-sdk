...
module UnifiedRubySDK
  module Operations
    ...
    class ListAccountingOrganizationsResponse < ::UnifiedRubySDK::Utils::FieldAugmented
      ...
      # Successful
      field :accounting_organizations, T.nilable(T::Array[Shared::AccountingOrganization])


      sig { params(content_type: String, raw_response: Faraday::Response, status_code: Integer, accounting_organizations: T.nilable(T::Array[Shared::AccountingOrganization])).void }
