...
module OpenApiSDK
  module Operations
    ...
    class ListCrmLeadsRequest < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
    ...
    class ListCrmLeadsResponse < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      # Successful
      field :crm_leads, T.nilable(T::Array[Shared::CrmLead])
      # Raw HTTP response; suitable for custom response parsing
      field :raw_response, T.nilable(Faraday::Response)


      sig { params(content_type: String, status_code: Integer, crm_leads: T.nilable(T::Array[Shared::CrmLead]), raw_response: T.nilable(Faraday::Response)).void }
      def initialize(content_type: nil, status_code: nil, crm_leads: nil, raw_response: nil)
