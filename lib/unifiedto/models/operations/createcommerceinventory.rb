...
module UnifiedRubySDK
  module Operations
    ...
    class CreateCommerceInventoryRequest < ::UnifiedRubySDK::Utils::FieldAugmented
      ...
      sig { params(connection_id: String, commerce_inventory: T.nilable(Shared::CommerceInventory)).void }
    ...
    class CreateCommerceInventoryResponse < ::UnifiedRubySDK::Utils::FieldAugmented
      extend T::Sig
