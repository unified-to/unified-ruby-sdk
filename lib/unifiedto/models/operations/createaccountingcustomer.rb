...
module UnifiedRubySDK
  module Operations
    ...
    class CreateAccountingCustomerRequest < UnifiedRubySDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(connection_id: String, accounting_customer: T.nilable(Shared::AccountingCustomer)).void }
      def initialize(connection_id: nil, accounting_customer: nil)
    ...
    class CreateAccountingCustomerResponse < UnifiedRubySDK::Utils::FieldAugmented
      extend T::Sig
