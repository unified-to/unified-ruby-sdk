...
module OpenApiSDK
  module Operations
    ...
    class ListAtsScorecardsRequest < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
    ...
    class ListAtsScorecardsResponse < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(content_type: String, status_code: Integer, ats_scorecards: T.nilable(T::Array[Shared::AtsScorecard]), raw_response: T.nilable(Faraday::Response)).void }
      def initialize(content_type: nil, status_code: nil, ats_scorecards: nil, raw_response: nil)
