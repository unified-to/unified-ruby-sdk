...
module OpenApiSDK
  module Operations
    ...
    class ListUnifiedWebhooksRequest < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
    ...
    class ListUnifiedWebhooksResponse < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(content_type: String, status_code: Integer, raw_response: T.nilable(Faraday::Response), webhooks: T.nilable(T::Array[Shared::Webhook])).void }
      def initialize(content_type: nil, status_code: nil, raw_response: nil, webhooks: nil)
