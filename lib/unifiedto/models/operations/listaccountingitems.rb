...
module UnifiedRubySDK
  module Operations
    ...
    class ListAccountingItemsRequest < ::UnifiedRubySDK::Utils::FieldAugmented
      extend T::Sig
    ...
    class ListAccountingItemsResponse < ::UnifiedRubySDK::Utils::FieldAugmented
      extend T::Sig
      ...
      # Successful
      field :accounting_items, T.nilable(T::Array[Shared::AccountingItem])


      sig { params(content_type: String, raw_response: Faraday::Response, status_code: Integer, accounting_items: T.nilable(T::Array[Shared::AccountingItem])).void }
      def initialize(content_type: nil, raw_response: nil, status_code: nil, accounting_items: nil)
