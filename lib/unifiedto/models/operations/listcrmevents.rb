...
module OpenApiSDK
  module Operations
    ...
    class ListCrmEventsRequest < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
    ...
    class ListCrmEventsResponse < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(content_type: String, status_code: Integer, crm_events: T.nilable(T::Array[Shared::CrmEvent]), raw_response: T.nilable(Faraday::Response)).void }
      def initialize(content_type: nil, status_code: nil, crm_events: nil, raw_response: nil)
