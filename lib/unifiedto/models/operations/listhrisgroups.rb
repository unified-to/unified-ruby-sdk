...
module UnifiedRubySDK
  module Operations
    ...
    class ListHrisGroupsResponse < UnifiedRubySDK::Utils::FieldAugmented
      ...
      # Successful
      field :hris_groups, T.nilable(T::Array[Shared::HrisGroup])


      sig { params(content_type: String, raw_response: Faraday::Response, status_code: Integer, hris_groups: T.nilable(T::Array[Shared::HrisGroup])).void }
