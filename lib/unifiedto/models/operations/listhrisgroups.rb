...
module OpenApiSDK
  module Operations
    ...
    class ListHrisGroupsResponse < OpenApiSDK::Utils::FieldAugmented
      ...
      sig { params(content_type: String, status_code: Integer, hris_groups: T.nilable(T::Array[Shared::HrisGroup]), raw_response: T.nilable(Faraday::Response)).void }
      def initialize(content_type: nil, status_code: nil, hris_groups: nil, raw_response: nil)
