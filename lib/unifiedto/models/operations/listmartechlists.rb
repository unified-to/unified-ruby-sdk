...
module OpenApiSDK
  module Operations
    ...
    class ListMartechListsRequest < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
    ...
    class ListMartechListsResponse < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      # Successful
      field :marketing_lists, T.nilable(T::Array[Shared::MarketingList])
      # Raw HTTP response; suitable for custom response parsing
      field :raw_response, T.nilable(Faraday::Response)


      sig { params(content_type: String, status_code: Integer, marketing_lists: T.nilable(T::Array[Shared::MarketingList]), raw_response: T.nilable(Faraday::Response)).void }
      def initialize(content_type: nil, status_code: nil, marketing_lists: nil, raw_response: nil)
