...
module OpenApiSDK
  module Operations
    ...
    class ListCrmPipelinesRequest < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
    ...
    class ListCrmPipelinesResponse < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      # Successful
      field :crm_pipelines, T.nilable(T::Array[Shared::CrmPipeline])
      # Raw HTTP response; suitable for custom response parsing
      field :raw_response, T.nilable(Faraday::Response)


      sig { params(content_type: String, status_code: Integer, crm_pipelines: T.nilable(T::Array[Shared::CrmPipeline]), raw_response: T.nilable(Faraday::Response)).void }
      def initialize(content_type: nil, status_code: nil, crm_pipelines: nil, raw_response: nil)
