...
module UnifiedRubySDK
  module Operations
    ...
    class ListCrmPipelinesRequest < ::UnifiedRubySDK::Utils::FieldAugmented
      extend T::Sig
    ...
    class ListCrmPipelinesResponse < ::UnifiedRubySDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(content_type: String, raw_response: Faraday::Response, status_code: Integer, crm_pipelines: T.nilable(T::Array[Shared::CrmPipeline])).void }
      def initialize(content_type: nil, raw_response: nil, status_code: nil, crm_pipelines: nil)
