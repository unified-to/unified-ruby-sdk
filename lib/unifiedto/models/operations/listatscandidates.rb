...
module OpenApiSDK
  module Operations
    ...
    class ListAtsCandidatesRequest < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
    ...
    class ListAtsCandidatesResponse < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      # Successful
      field :ats_candidates, T.nilable(T::Array[Shared::AtsCandidate])
      # Raw HTTP response; suitable for custom response parsing
      field :raw_response, T.nilable(Faraday::Response)


      sig { params(content_type: String, status_code: Integer, ats_candidates: T.nilable(T::Array[Shared::AtsCandidate]), raw_response: T.nilable(Faraday::Response)).void }
      def initialize(content_type: nil, status_code: nil, ats_candidates: nil, raw_response: nil)
