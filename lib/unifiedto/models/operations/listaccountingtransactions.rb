...
module UnifiedRubySDK
  module Operations
    ...
    class ListAccountingTransactionsRequest < UnifiedRubySDK::Utils::FieldAugmented
      extend T::Sig
    ...
    class ListAccountingTransactionsResponse < UnifiedRubySDK::Utils::FieldAugmented
      extend T::Sig
      ...
      # Successful
      field :accounting_transactions, T.nilable(T::Array[Shared::AccountingTransaction])


      sig { params(content_type: String, raw_response: Faraday::Response, status_code: Integer, accounting_transactions: T.nilable(T::Array[Shared::AccountingTransaction])).void }
      def initialize(content_type: nil, raw_response: nil, status_code: nil, accounting_transactions: nil)
