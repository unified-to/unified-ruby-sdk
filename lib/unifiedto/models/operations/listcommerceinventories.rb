...
module UnifiedRubySDK
  module Operations
    ...
    class ListCommerceInventoriesRequest < ::UnifiedRubySDK::Utils::FieldAugmented
      extend T::Sig
    ...
    class ListCommerceInventoriesResponse < ::UnifiedRubySDK::Utils::FieldAugmented
      extend T::Sig
      ...
      # Successful
      field :commerce_inventories, T.nilable(T::Array[Shared::CommerceInventory])


      sig { params(content_type: String, raw_response: Faraday::Response, status_code: Integer, commerce_inventories: T.nilable(T::Array[Shared::CommerceInventory])).void }
