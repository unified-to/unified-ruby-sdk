...
module UnifiedRubySDK
  module Operations
    ...
    class ListCrmCompaniesRequest < ::UnifiedRubySDK::Utils::FieldAugmented
      ...
      sig { params(connection_id: String, contact_id: T.nilable(String), deal_id: T.nilable(String), fields: T.nilable(T::Array[String]), limit: T.nilable(Float), offset: T.nilable(Float), order: T.nilable(String), query: T.nilable(String), sort: T.nilable(String), updated_gte: T.nilable(DateTime), user_id: T.nilable(String)).void }
      def initialize(connection_id: nil, contact_id: nil, deal_id: nil, fields: nil, limit: nil, offset: nil, order: nil, query: nil, sort: nil, updated_gte: nil, user_id: nil)
    ...
    class ListCrmCompaniesResponse < ::UnifiedRubySDK::Utils::FieldAugmented
      extend T::Sig
