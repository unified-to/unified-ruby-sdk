...
module OpenApiSDK
  module Operations
    ...
    class ListEnrichPeopleResponse < OpenApiSDK::Utils::FieldAugmented
      ...
      sig { params(content_type: String, status_code: Integer, enrich_person: T.nilable(Shared::EnrichPerson), raw_response: T.nilable(Faraday::Response)).void }
      def initialize(content_type: nil, status_code: nil, enrich_person: nil, raw_response: nil)
