...
module UnifiedRubySDK
  module Operations
    ...
    class ListCommerceItemsResponse < ::UnifiedRubySDK::Utils::FieldAugmented
      extend T::Sig
      ...
      # Successful
      field :commerce_items, T.nilable(T::Array[Shared::CommerceItem])


      sig { params(content_type: String, raw_response: Faraday::Response, status_code: Integer, commerce_items: T.nilable(T::Array[Shared::CommerceItem])).void }
