...
module UnifiedRubySDK
  module Operations
    ...
    class ListAtsJobsResponse < ::UnifiedRubySDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(content_type: String, raw_response: Faraday::Response, status_code: Integer, ats_jobs: T.nilable(T::Array[Shared::AtsJob])).void }
