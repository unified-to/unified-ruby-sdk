...
module OpenApiSDK
  module Operations
    ...
    class ListAccountingCustomersRequest < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
    ...
    class ListAccountingCustomersResponse < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(content_type: String, status_code: Integer, accounting_customers: T.nilable(T::Array[Shared::AccountingCustomer]), raw_response: T.nilable(Faraday::Response)).void }
      def initialize(content_type: nil, status_code: nil, accounting_customers: nil, raw_response: nil)
