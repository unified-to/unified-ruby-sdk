...
module OpenApiSDK
  module Operations
    ...
    class ListTicketingCustomersRequest < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
    ...
    class ListTicketingCustomersResponse < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(content_type: String, status_code: Integer, raw_response: T.nilable(Faraday::Response), ticketing_customers: T.nilable(T::Array[Shared::TicketingCustomer])).void }
      def initialize(content_type: nil, status_code: nil, raw_response: nil, ticketing_customers: nil)
