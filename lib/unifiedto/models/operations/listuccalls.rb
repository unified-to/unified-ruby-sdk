...
module OpenApiSDK
  module Operations
    ...
    class ListUcCallsRequest < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
    ...
    class ListUcCallsResponse < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      # Successful
      field :uc_calls, T.nilable(T::Array[Shared::UcCall])


      sig { params(content_type: String, status_code: Integer, raw_response: T.nilable(Faraday::Response), uc_calls: T.nilable(T::Array[Shared::UcCall])).void }
      def initialize(content_type: nil, status_code: nil, raw_response: nil, uc_calls: nil)
