...
module UnifiedRubySDK
  module Operations
    ...
    class ListUcCallsResponse < UnifiedRubySDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(content_type: String, raw_response: Faraday::Response, status_code: Integer, uc_calls: T.nilable(T::Array[Shared::UcCall])).void }
      def initialize(content_type: nil, raw_response: nil, status_code: nil, uc_calls: nil)
