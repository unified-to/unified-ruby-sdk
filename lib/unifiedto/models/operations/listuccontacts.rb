...
module OpenApiSDK
  module Operations
    ...
    class ListUcContactsResponse < OpenApiSDK::Utils::FieldAugmented
      ...
      sig { params(content_type: String, status_code: Integer, raw_response: T.nilable(Faraday::Response), uc_contacts: T.nilable(T::Array[Shared::UcContact])).void }
      def initialize(content_type: nil, status_code: nil, raw_response: nil, uc_contacts: nil)
