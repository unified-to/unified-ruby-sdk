...
module UnifiedRubySDK
  module Operations
    ...
    class ListAtsApplicationstatusesRequest < ::UnifiedRubySDK::Utils::FieldAugmented
      extend T::Sig
    ...
    class ListAtsApplicationstatusesResponse < ::UnifiedRubySDK::Utils::FieldAugmented
      extend T::Sig
      ...
      # Successful
      field :ats_statuses, T.nilable(T::Array[Shared::AtsStatus])


      sig { params(content_type: String, raw_response: Faraday::Response, status_code: Integer, ats_statuses: T.nilable(T::Array[Shared::AtsStatus])).void }
      def initialize(content_type: nil, raw_response: nil, status_code: nil, ats_statuses: nil)
        @content_type = content_type
        @raw_response = raw_response
        @status_code = status_code
        @ats_statuses = ats_statuses
      end
    end
  end
end
