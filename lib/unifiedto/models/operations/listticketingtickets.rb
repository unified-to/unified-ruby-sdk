...
module OpenApiSDK
  module Operations
    ...
    class ListTicketingTicketsRequest < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
    ...
    class ListTicketingTicketsResponse < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      # Successful
      field :ticketing_tickets, T.nilable(T::Array[Shared::TicketingTicket])


      sig { params(content_type: String, status_code: Integer, raw_response: T.nilable(Faraday::Response), ticketing_tickets: T.nilable(T::Array[Shared::TicketingTicket])).void }
      def initialize(content_type: nil, status_code: nil, raw_response: nil, ticketing_tickets: nil)
