...
module OpenApiSDK
  module Operations
    ...
    class ListCrmFilesRequest < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
    ...
    class ListCrmFilesResponse < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(content_type: String, status_code: Integer, crm_files: T.nilable(T::Array[Shared::CrmFile]), raw_response: T.nilable(Faraday::Response)).void }
      def initialize(content_type: nil, status_code: nil, crm_files: nil, raw_response: nil)
