...
module OpenApiSDK
  module Operations
    ...
    class ListTicketingNotesRequest < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
    ...
    class ListTicketingNotesResponse < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(content_type: String, status_code: Integer, raw_response: T.nilable(Faraday::Response), ticketing_notes: T.nilable(T::Array[Shared::TicketingNote])).void }
      def initialize(content_type: nil, status_code: nil, raw_response: nil, ticketing_notes: nil)
