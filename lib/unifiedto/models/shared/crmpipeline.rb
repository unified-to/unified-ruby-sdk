...
module OpenApiSDK
  module Shared
    ...
    class CrmPipeline < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig


      field :created_at, T.nilable(DateTime), { 'format_json': { 'letter_case': OpenApiSDK::Utils.field_name('created_at'), 'decoder': Utils.datetime_from_iso_format(true) } }

      field :deal_probability, T.nilable(T::Boolean), { 'format_json': { 'letter_case': OpenApiSDK::Utils.field_name('deal_probability') } }

      field :display_order, T.nilable(Float), { 'format_json': { 'letter_case': OpenApiSDK::Utils.field_name('display_order') } }
      ...
      field :raw, T.nilable(Shared::PropertyCrmPipelineRaw), { 'format_json': { 'letter_case': OpenApiSDK::Utils.field_name('raw') } }
