...
module UnifiedRubySDK
  module Shared
    ...
    class CommerceItemVariant < ::UnifiedRubySDK::Utils::FieldAugmented
      ...
      field :options, T.nilable(T::Array[Shared::CommerceItemOption]), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('options') } }

      field :prices, T.nilable(T::Array[Shared::CommerceItemPrice]), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('prices') } }
      ...
      field :size_unit, T.nilable(Shared::SizeUnit), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('size_unit'), 'decoder': Utils.enum_from_string(Shared::SizeUnit, true) } }
      ...
      field :weight_unit, T.nilable(Shared::WeightUnit), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('weight_unit'), 'decoder': Utils.enum_from_string(Shared::WeightUnit, true) } }

      field :width, T.nilable(Float), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('width') } }


      sig { params(name: String, available_at: T.nilable(DateTime), description: T.nilable(String), height: T.nilable(Float), id: T.nilable(String), inventory_id: T.nilable(String), is_active: T.nilable(T::Boolean), is_featured: T.nilable(T::Boolean), is_visible: T.nilable(T::Boolean), length: T.nilable(Float), media: T.nilable(T::Array[Shared::CommerceItemMedia]), options: T.nilable(T::Array[Shared::CommerceItemOption]), prices: T.nilable(T::Array[Shared::CommerceItemPrice]), public_description: T.nilable(String), public_name: T.nilable(String), requires_shipping: T.nilable(T::Boolean), size_unit: T.nilable(Shared::SizeUnit), sku: T.nilable(String), tags: T.nilable(T::Array[String]), total_stock: T.nilable(Float), weight: T.nilable(Float), weight_unit: T.nilable(Shared::WeightUnit), width: T.nilable(Float)).void }
      def initialize(name: nil, available_at: nil, description: nil, height: nil, id: nil, inventory_id: nil, is_active: nil, is_featured: nil, is_visible: nil, length: nil, media: nil, options: nil, prices: nil, public_description: nil, public_name: nil, requires_shipping: nil, size_unit: nil, sku: nil, tags: nil, total_stock: nil, weight: nil, weight_unit: nil, width: nil)
        @name = name
