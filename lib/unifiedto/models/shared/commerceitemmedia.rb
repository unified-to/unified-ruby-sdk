...
module UnifiedRubySDK
  module Shared
    ...
    class CommerceItemMedia < ::UnifiedRubySDK::Utils::FieldAugmented
      ...
      field :type, T.nilable(Shared::CommerceItemMediaType), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('type'), 'decoder': Utils.enum_from_string(Shared::CommerceItemMediaType, true) } }

      field :width, T.nilable(Float), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('width') } }


      sig { params(url: String, alt: T.nilable(String), height: T.nilable(Float), position: T.nilable(Float), type: T.nilable(Shared::CommerceItemMediaType), width: T.nilable(Float)).void }
