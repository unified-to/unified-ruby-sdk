...
module UnifiedRubySDK
  module Shared
    ...
    class CommerceCollection < ::UnifiedRubySDK::Utils::FieldAugmented
      ...
      sig { params(id: String, name: String, created_at: T.nilable(DateTime), description: T.nilable(String), is_active: T.nilable(T::Boolean), is_featured: T.nilable(T::Boolean), is_visible: T.nilable(T::Boolean), item_ids: T.nilable(T::Array[String]), media: T.nilable(T::Array[Shared::CommerceItemMedia]), public_description: T.nilable(String), public_name: T.nilable(String), raw: T.nilable(T::Hash[Symbol, Object]), tags: T.nilable(T::Array[String]), updated_at: T.nilable(DateTime)).void }
