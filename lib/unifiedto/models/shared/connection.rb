...
module UnifiedRubySDK
  module Shared
    ...
    class Connection < ::UnifiedRubySDK::Utils::FieldAugmented
      ...
      field :categories, T::Array[Shared::PropertyConnectionCategories], { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('categories') } }

      field :integration_type, String, { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('integration_type') } }

      field :permissions, T::Array[Shared::PropertyConnectionPermissions], { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('permissions') } }
      # An authentication object that represents a specific authorized user's connection to an integration.
      field :auth, T.nilable(Shared::PropertyConnectionAuth), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('auth') } }
      ...
      sig { params(categories: T::Array[Shared::PropertyConnectionCategories], integration_type: String, permissions: T::Array[Shared::PropertyConnectionPermissions], auth: T.nilable(Shared::PropertyConnectionAuth), auth_aws_arn: T.nilable(String), created_at: T.nilable(DateTime), cursors_cache: T.nilable(T::Array[T::Hash[Symbol, Object]]), environment: T.nilable(String), external_xref: T.nilable(String), id: T.nilable(String), is_paused: T.nilable(T::Boolean), last_healthy_at: T.nilable(DateTime), last_unhealthy_at: T.nilable(DateTime), updated_at: T.nilable(DateTime), workspace_id: T.nilable(String)).void }
