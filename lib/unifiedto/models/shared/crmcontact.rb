...
module UnifiedRubySDK
  module Shared
    ...
    class CrmContact < ::UnifiedRubySDK::Utils::FieldAugmented
      ...
      field :address, T.nilable(Shared::PropertyCrmContactAddress), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('address') } }
