...
module UnifiedRubySDK
  module Shared
    ...
    class AtsInterview < ::UnifiedRubySDK::Utils::FieldAugmented
      ...
      sig { params(application_id: T.nilable(String), candidate_id: T.nilable(String), created_at: T.nilable(DateTime), end_at: T.nilable(DateTime), external_event_xref: T.nilable(String), id: T.nilable(String), job_id: T.nilable(String), location: T.nilable(String), raw: T.nilable(T::Hash[Symbol, Object]), start_at: T.nilable(DateTime), status: T.nilable(Shared::AtsInterviewStatus), updated_at: T.nilable(DateTime), user_ids: T.nilable(T::Array[String])).void }
