...
module OpenApiSDK
  module Shared
    ...
    class UcContact < OpenApiSDK::Utils::FieldAugmented
      extend T::Sig
      ...
      field :emails, T.nilable(T::Array[Shared::UcEmail]), { 'format_json': { 'letter_case': OpenApiSDK::Utils.field_name('emails') } }

      field :id, T.nilable(String), { 'format_json': { 'letter_case': OpenApiSDK::Utils.field_name('id') } }

      field :name, T.nilable(String), { 'format_json': { 'letter_case': OpenApiSDK::Utils.field_name('name') } }
      # The raw data returned by the integration for this contact
      field :raw, T.nilable(Shared::PropertyUcContactRaw), { 'format_json': { 'letter_case': OpenApiSDK::Utils.field_name('raw') } }
      # An array of telephones for this contact
      field :telephones, T.nilable(T::Array[Shared::UcTelephone]), { 'format_json': { 'letter_case': OpenApiSDK::Utils.field_name('telephones') } }
