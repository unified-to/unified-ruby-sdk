  ...
  module Models
    module Operations
      ...
      class ListAccountingQuotesRequest
        ...
        # Fields to return
        field :fields_, Crystalline::Nilable.new(Crystalline::Array.new(Models::Operations::ListAccountingQuotesQueryParamFields)), { 'query_param': { 'field_name': 'fields', 'style': 'form', 'explode': true } }
        ...
        field :project_id, Crystalline::Nilable.new(::String), { 'query_param': { 'field_name': 'project_id', 'style': 'form', 'explode': true } }
        ...
        sig { params(connection_id: ::String, contact_id: T.nilable(::String), end_lt: T.nilable(::String), fields_: T.nilable(T::Array[Models::Operations::ListAccountingQuotesQueryParamFields]), limit: T.nilable(::Float), offset: T.nilable(::Float), order: T.nilable(::String), org_id: T.nilable(::String), project_id: T.nilable(::String), query: T.nilable(::String), raw: T.nilable(::String), sort: T.nilable(::String), start_gte: T.nilable(::String), status: T.nilable(::String), updated_gte: T.nilable(::String)).void }
        def initialize(connection_id:, contact_id: nil, end_lt: nil, fields_: nil, limit: nil, offset: nil, order: nil, org_id: nil, project_id: nil, query: nil, raw: nil, sort: nil, start_gte: nil, status: nil, updated_gte: nil)
