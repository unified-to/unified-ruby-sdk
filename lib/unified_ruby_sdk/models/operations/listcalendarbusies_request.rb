  ...
  module Models
    module Operations
      ...
      class ListCalendarBusiesRequest
        ...
        sig { params(connection_id: ::String, calendar_id: T.nilable(::String), end_le: T.nilable(::String), end_lt: T.nilable(::String), fields_: T.nilable(T::Array[::String]), limit: T.nilable(::Float), offset: T.nilable(::Float), order: T.nilable(::String), query: T.nilable(::String), raw: T.nilable(::String), sort: T.nilable(::String), start_gte: T.nilable(::String), updated_gte: T.nilable(::String), user_id: T.nilable(::String)).void }
        def initialize(connection_id:, calendar_id: nil, end_le: nil, end_lt: nil, fields_: nil, limit: nil, offset: nil, order: nil, query: nil, raw: nil, sort: nil, start_gte: nil, updated_gte: nil, user_id: nil)
