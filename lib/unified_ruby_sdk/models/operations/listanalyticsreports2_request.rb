  ...
  module Models
    module Operations
      ...
      class ListAnalyticsReports2Request
        ...
        field :dimension, Crystalline::Nilable.new(::String), { 'query_param': { 'field_name': 'dimension', 'style': 'form', 'explode': true } }
        # The end date to filter by (ISO-8601 / YYYY-MM-DDTHH:MM:SSZ format)
        field :end_lt, Crystalline::Nilable.new(::String), { 'query_param': { 'field_name': 'end_lt', 'style': 'form', 'explode': true } }
        # Fields to return
        field :fields_, Crystalline::Nilable.new(Crystalline::Array.new(Models::Operations::ListAnalyticsReports2QueryParamFields)), { 'query_param': { 'field_name': 'fields', 'style': 'form', 'explode': true } }
        ...
        sig { params(connection_id: ::String, dimension: T.nilable(::String), end_lt: T.nilable(::String), fields_: T.nilable(T::Array[Models::Operations::ListAnalyticsReports2QueryParamFields]), limit: T.nilable(::Float), offset: T.nilable(::Float), order: T.nilable(::String), property_id: T.nilable(::String), query: T.nilable(::String), raw: T.nilable(::String), sort: T.nilable(::String), start_gte: T.nilable(::String), type: T.nilable(::String), updated_gte: T.nilable(::String)).void }
        def initialize(connection_id:, dimension: nil, end_lt: nil, fields_: nil, limit: nil, offset: nil, order: nil, property_id: nil, query: nil, raw: nil, sort: nil, start_gte: nil, type: nil, updated_gte: nil)
