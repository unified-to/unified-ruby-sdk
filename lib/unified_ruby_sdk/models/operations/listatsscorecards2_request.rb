  ...
  module Models
    module Operations
      ...
      class ListAtsScorecards2Request
        ...
        # Fields to return
        field :fields_, Crystalline::Nilable.new(Crystalline::Array.new(Models::Operations::ListAtsScorecards2QueryParamFields)), { 'query_param': { 'field_name': 'fields', 'style': 'form', 'explode': true } }
        ...
        sig { params(connection_id: ::String, application_id: T.nilable(::String), candidate_id: T.nilable(::String), fields_: T.nilable(T::Array[Models::Operations::ListAtsScorecards2QueryParamFields]), interview_id: T.nilable(::String), job_id: T.nilable(::String), limit: T.nilable(::Float), offset: T.nilable(::Float), order: T.nilable(::String), query: T.nilable(::String), raw: T.nilable(::String), sort: T.nilable(::String), updated_gte: T.nilable(::String)).void }
        def initialize(connection_id:, application_id: nil, candidate_id: nil, fields_: nil, interview_id: nil, job_id: nil, limit: nil, offset: nil, order: nil, query: nil, raw: nil, sort: nil, updated_gte: nil)
