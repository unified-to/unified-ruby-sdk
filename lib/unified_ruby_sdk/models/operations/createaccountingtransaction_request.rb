  ...
  module Models
    module Operations
      ...
      class CreateAccountingTransactionRequest
        ...
        sig { params(accounting_transaction: Models::Shared::AccountingTransaction, connection_id: ::String, fields_: T.nilable(T::Array[::String]), raw: T.nilable(::String)).void }
        def initialize(accounting_transaction: nil, connection_id: nil, fields_: nil, raw: nil)
