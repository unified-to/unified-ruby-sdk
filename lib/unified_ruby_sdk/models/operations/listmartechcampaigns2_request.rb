  ...
  module Models
    module Operations
      ...
      class ListMartechCampaigns2Request
        ...
        # Fields to return
        field :fields_, Crystalline::Nilable.new(Crystalline::Array.new(Models::Operations::ListMartechCampaigns2QueryParamFields)), { 'query_param': { 'field_name': 'fields', 'style': 'form', 'explode': true } }

        field :limit, Crystalline::Nilable.new(::Float), { 'query_param': { 'field_name': 'limit', 'style': 'form', 'explode': true } }
        # The list ID to filter by
        field :list_id, Crystalline::Nilable.new(::String), { 'query_param': { 'field_name': 'list_id', 'style': 'form', 'explode': true } }
        # The member ID to filter by
        field :member_id, Crystalline::Nilable.new(::String), { 'query_param': { 'field_name': 'member_id', 'style': 'form', 'explode': true } }
        ...
        sig { params(connection_id: ::String, fields_: T.nilable(T::Array[Models::Operations::ListMartechCampaigns2QueryParamFields]), limit: T.nilable(::Float), list_id: T.nilable(::String), member_id: T.nilable(::String), offset: T.nilable(::Float), order: T.nilable(::String), query: T.nilable(::String), raw: T.nilable(::String), sort: T.nilable(::String), updated_gte: T.nilable(::String)).void }
        def initialize(connection_id:, fields_: nil, limit: nil, list_id: nil, member_id: nil, offset: nil, order: nil, query: nil, raw: nil, sort: nil, updated_gte: nil)
