  ...
  module Models
    module Operations
      ...
      class PatchAccountingContactRequest
        ...
        sig { params(accounting_contact: Models::Shared::AccountingContact, connection_id: ::String, id: ::String, fields_: T.nilable(T::Array[::String]), raw: T.nilable(::String)).void }
        def initialize(accounting_contact: nil, connection_id: nil, id: nil, fields_: nil, raw: nil)
