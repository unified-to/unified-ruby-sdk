  ...
  module Models
    module Operations
      ...
      class ListCalendarRecordingsRequest
        ...
        def initialize(connection_id:, end_le: nil, event_id: nil, fields_: nil, limit: nil, offset: nil, order: nil, query: nil, raw: nil, sort: nil, start_gte: nil, updated_gte: nil)
