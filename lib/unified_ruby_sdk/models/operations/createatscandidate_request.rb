  ...
  module Models
    module Operations
      ...
      class CreateAtsCandidateRequest
        ...
        sig { params(ats_candidate: Models::Shared::AtsCandidate, connection_id: ::String, fields_: T.nilable(T::Array[::String]), raw: T.nilable(::String)).void }
        def initialize(ats_candidate: nil, connection_id: nil, fields_: nil, raw: nil)
