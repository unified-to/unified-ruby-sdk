  ...
  module Models
    module Operations
      ...
      class ListCrmCompaniesRequest
        ...
        def initialize(connection_id: nil, contact_id: nil, deal_id: nil, fields_: nil, limit: nil, offset: nil, order: nil, query: nil, raw: nil, sort: nil, updated_gte: nil, user_id: nil)
