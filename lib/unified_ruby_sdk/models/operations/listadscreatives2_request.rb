  ...
  module Models
    module Operations
      ...
      class ListAdsCreatives2Request
        ...
        # Fields to return
        field :fields_, Crystalline::Nilable.new(Crystalline::Array.new(Models::Operations::ListAdsCreatives2QueryParamFields)), { 'query_param': { 'field_name': 'fields', 'style': 'form', 'explode': true } }
        ...
        sig { params(connection_id: ::String, fields_: T.nilable(T::Array[Models::Operations::ListAdsCreatives2QueryParamFields]), group_id: T.nilable(::String), limit: T.nilable(::Float), offset: T.nilable(::Float), order: T.nilable(::String), org_id: T.nilable(::String), query: T.nilable(::String), raw: T.nilable(::String), sort: T.nilable(::String), status: T.nilable(::String), updated_gte: T.nilable(::String)).void }
        def initialize(connection_id:, fields_: nil, group_id: nil, limit: nil, offset: nil, order: nil, org_id: nil, query: nil, raw: nil, sort: nil, status: nil, updated_gte: nil)
