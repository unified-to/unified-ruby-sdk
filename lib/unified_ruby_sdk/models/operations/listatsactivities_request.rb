  ...
  module Models
    module Operations
      ...
      class ListAtsActivitiesRequest
        ...
        def initialize(connection_id: nil, application_id: nil, candidate_id: nil, document_id: nil, fields_: nil, interview_id: nil, job_id: nil, limit: nil, offset: nil, order: nil, query: nil, raw: nil, sort: nil, type: nil, updated_gte: nil, user_id: nil)
