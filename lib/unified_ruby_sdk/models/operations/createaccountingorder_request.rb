  ...
  module Models
    module Operations
      ...
      class CreateAccountingOrderRequest
        ...
        sig { params(accounting_order: Models::Shared::AccountingOrder, connection_id: ::String, fields_: T.nilable(T::Array[::String]), raw: T.nilable(::String)).void }
        def initialize(accounting_order: nil, connection_id: nil, fields_: nil, raw: nil)
