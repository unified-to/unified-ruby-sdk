  ...
  module Models
    module Operations
      ...
      class CreateTaskTaskRequest
        ...
        sig { params(connection_id: ::String, task_task: Models::Shared::TaskTask, fields_: T.nilable(T::Array[::String]), raw: T.nilable(::String)).void }
        def initialize(connection_id: nil, task_task: nil, fields_: nil, raw: nil)
