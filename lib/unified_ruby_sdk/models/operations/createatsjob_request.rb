  ...
  module Models
    module Operations
      ...
      class CreateAtsJobRequest
        ...
        sig { params(ats_job: Models::Shared::AtsJob, connection_id: ::String, fields_: T.nilable(T::Array[::String]), raw: T.nilable(::String)).void }
        def initialize(ats_job: nil, connection_id: nil, fields_: nil, raw: nil)
          @ats_job = ats_job
