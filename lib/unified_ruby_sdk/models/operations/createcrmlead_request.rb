  ...
  module Models
    module Operations
      ...
      class CreateCrmLeadRequest
        ...
        sig { params(connection_id: ::String, crm_lead: Models::Shared::CrmLead, fields_: T.nilable(T::Array[::String]), raw: T.nilable(::String)).void }
        def initialize(connection_id: nil, crm_lead: nil, fields_: nil, raw: nil)
