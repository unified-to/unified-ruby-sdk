  ...
  module Models
    module Operations
      ...
      class CreateAtsInterviewRequest
        ...
        sig { params(ats_interview: Models::Shared::AtsInterview, connection_id: ::String, fields_: T.nilable(T::Array[::String]), raw: T.nilable(::String)).void }
        def initialize(ats_interview: nil, connection_id: nil, fields_: nil, raw: nil)
