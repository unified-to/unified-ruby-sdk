  ...
  module Models
    module Operations
      ...
      class ListCalendarEvents2Request
        ...
        # Fields to return
        field :fields_, Crystalline::Nilable.new(Crystalline::Array.new(Models::Operations::ListCalendarEvents2QueryParamFields)), { 'query_param': { 'field_name': 'fields', 'style': 'form', 'explode': true } }
        ...
        sig { params(connection_id: ::String, calendar_id: T.nilable(::String), end_lt: T.nilable(::String), expand: T.nilable(T::Boolean), fields_: T.nilable(T::Array[Models::Operations::ListCalendarEvents2QueryParamFields]), limit: T.nilable(::Float), offset: T.nilable(::Float), order: T.nilable(::String), query: T.nilable(::String), raw: T.nilable(::String), sort: T.nilable(::String), start_gte: T.nilable(::String), updated_gte: T.nilable(::String)).void }
        def initialize(connection_id:, calendar_id: nil, end_lt: nil, expand: nil, fields_: nil, limit: nil, offset: nil, order: nil, query: nil, raw: nil, sort: nil, start_gte: nil, updated_gte: nil)
