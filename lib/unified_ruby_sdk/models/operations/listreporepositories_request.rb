...
module UnifiedRubySDK
  module Operations
    ...
    class ListRepoRepositoriesRequest < ::UnifiedRubySDK::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(connection_id: ::String, fields_: T.nilable(T::Array[::String]), limit: T.nilable(::Float), offset: T.nilable(::Float), order: T.nilable(::String), org_id: T.nilable(::String), query: T.nilable(::String), sort: T.nilable(::String), updated_gte: T.nilable(::DateTime)).void }
      def initialize(connection_id: nil, fields_: nil, limit: nil, offset: nil, order: nil, org_id: nil, query: nil, sort: nil, updated_gte: nil)
