  ...
  module Models
    module Operations
      ...
      class PatchTicketingCustomerRequest
        ...
        sig { params(ticketing_customer: Models::Shared::TicketingCustomer, connection_id: ::String, id: ::String, fields_: T.nilable(T::Array[::String]), raw: T.nilable(::String)).void }
