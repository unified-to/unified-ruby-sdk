  ...
  module Models
    module Operations
      ...
      class ListAccountingVendorcreditsRequest
        ...
        # Fields to return
        field :fields_, Crystalline::Nilable.new(Crystalline::Array.new(Models::Operations::ListAccountingVendorcreditsQueryParamFields)), { 'query_param': { 'field_name': 'fields', 'style': 'form', 'explode': true } }
        ...
        sig { params(connection_id: ::String, contact_id: T.nilable(::String), fields_: T.nilable(T::Array[Models::Operations::ListAccountingVendorcreditsQueryParamFields]), limit: T.nilable(::Float), offset: T.nilable(::Float), order: T.nilable(::String), org_id: T.nilable(::String), query: T.nilable(::String), raw: T.nilable(::String), sort: T.nilable(::String), updated_gte: T.nilable(::String)).void }
        def initialize(connection_id:, contact_id: nil, fields_: nil, limit: nil, offset: nil, order: nil, org_id: nil, query: nil, raw: nil, sort: nil, updated_gte: nil)
