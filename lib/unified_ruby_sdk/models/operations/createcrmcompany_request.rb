  ...
  module Models
    module Operations
      ...
      class CreateCrmCompanyRequest
        ...
        sig { params(connection_id: ::String, crm_company: Models::Shared::CrmCompany, fields_: T.nilable(T::Array[::String]), raw: T.nilable(::String)).void }
        def initialize(connection_id: nil, crm_company: nil, fields_: nil, raw: nil)
