  ...
  module Models
    module Operations
      ...
      class UpdateHrisEmployeeRequest
        ...
        sig { params(connection_id: ::String, hris_employee: Models::Shared::HrisEmployee, id: ::String, fields_: T.nilable(T::Array[::String]), raw: T.nilable(::String)).void }
        def initialize(connection_id: nil, hris_employee: nil, id: nil, fields_: nil, raw: nil)
