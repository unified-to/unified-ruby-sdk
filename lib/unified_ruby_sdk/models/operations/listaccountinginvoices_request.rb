...
module UnifiedRubySDK
  module Operations
    ...
    class ListAccountingInvoicesRequest < ::UnifiedRubySDK::Utils::FieldAugmented
      ...
      sig { params(connection_id: ::String, contact_id: T.nilable(::String), fields_: T.nilable(T::Array[::String]), limit: T.nilable(::Float), offset: T.nilable(::Float), order: T.nilable(::String), query: T.nilable(::String), sort: T.nilable(::String), type: T.nilable(::String), updated_gte: T.nilable(::DateTime)).void }
      def initialize(connection_id: nil, contact_id: nil, fields_: nil, limit: nil, offset: nil, order: nil, query: nil, sort: nil, type: nil, updated_gte: nil)
