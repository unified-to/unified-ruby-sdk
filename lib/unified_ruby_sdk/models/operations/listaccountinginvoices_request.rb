  ...
  module Models
    module Operations
      ...
      class ListAccountingInvoicesRequest
        ...
        def initialize(connection_id: nil, contact_id: nil, fields_: nil, limit: nil, offset: nil, order: nil, org_id: nil, query: nil, raw: nil, sort: nil, type: nil, updated_gte: nil)
