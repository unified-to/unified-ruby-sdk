  ...
  module Models
    module Operations
      ...
      class UpdateTicketingCustomerRequest
        ...
        sig { params(connection_id: ::String, id: ::String, ticketing_customer: Models::Shared::TicketingCustomer, fields_: T.nilable(T::Array[::String]), raw: T.nilable(::String)).void }
        def initialize(connection_id: nil, id: nil, ticketing_customer: nil, fields_: nil, raw: nil)
