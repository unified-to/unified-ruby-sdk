  ...
  module Models
    module Operations
      ...
      class ListLmsInstructorsRequest
        ...
        def initialize(connection_id: nil, class_id: nil, company_id: nil, course_id: nil, fields_: nil, limit: nil, location_id: nil, offset: nil, order: nil, query: nil, raw: nil, session_id: nil, sort: nil, updated_gte: nil)
