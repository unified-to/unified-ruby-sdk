  ...
  module Models
    module Operations
      ...
      class ListLmsCoursesRequest
        ...
        field :fields_, Crystalline::Nilable.new(Crystalline::Array.new(Models::Operations::ListLmsCoursesQueryParamFields)), { 'query_param': { 'field_name': 'fields', 'style': 'form', 'explode': true } }
        ...
        sig { params(connection_id: ::String, class_id: T.nilable(::String), company_id: T.nilable(::String), fields_: T.nilable(T::Array[Models::Operations::ListLmsCoursesQueryParamFields]), limit: T.nilable(::Float), offset: T.nilable(::Float), order: T.nilable(::String), query: T.nilable(::String), raw: T.nilable(::String), sort: T.nilable(::String), updated_gte: T.nilable(::String)).void }
