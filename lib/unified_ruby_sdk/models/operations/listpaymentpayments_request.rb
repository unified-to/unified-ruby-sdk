  ...
  module Models
    module Operations
      ...
      class ListPaymentPaymentsRequest
        ...
        sig { params(connection_id: ::String, bill_id: T.nilable(::String), contact_id: T.nilable(::String), end_lt: T.nilable(::String), fields_: T.nilable(T::Array[Models::Operations::ListPaymentPaymentsQueryParamFields]), invoice_id: T.nilable(::String), limit: T.nilable(::Float), link_id: T.nilable(::String), offset: T.nilable(::Float), order: T.nilable(::String), query: T.nilable(::String), raw: T.nilable(::String), sort: T.nilable(::String), start_gte: T.nilable(::String), type: T.nilable(::String), updated_gte: T.nilable(::String)).void }
        def initialize(connection_id:, bill_id: nil, contact_id: nil, end_lt: nil, fields_: nil, invoice_id: nil, limit: nil, link_id: nil, offset: nil, order: nil, query: nil, raw: nil, sort: nil, start_gte: nil, type: nil, updated_gte: nil)
