  ...
  module Models
    module Operations
      ...
      class ListPaymentPaymentsRequest
        ...
        sig { params(connection_id: ::String, contact_id: T.nilable(::String), fields_: T.nilable(T::Array[::String]), invoice_id: T.nilable(::String), limit: T.nilable(::Float), offset: T.nilable(::Float), order: T.nilable(::String), query: T.nilable(::String), raw: T.nilable(::String), sort: T.nilable(::String), updated_gte: T.nilable(::DateTime)).void }
        def initialize(connection_id: nil, contact_id: nil, fields_: nil, invoice_id: nil, limit: nil, offset: nil, order: nil, query: nil, raw: nil, sort: nil, updated_gte: nil)
