  ...
  module Models
    module Operations
      ...
      class ListAccountingTrialbalancesRequest
        ...
        def initialize(connection_id:, end_le: nil, end_lt: nil, fields_: nil, limit: nil, offset: nil, order: nil, query: nil, raw: nil, sort: nil, start_gte: nil, updated_gte: nil)
