  ...
  module Models
    module Operations
      ...
      class PatchAtsActivityRequest
        ...
        sig { params(ats_activity: Models::Shared::AtsActivity, connection_id: ::String, id: ::String, fields_: T.nilable(T::Array[::String]), raw: T.nilable(::String)).void }
        def initialize(ats_activity: nil, connection_id: nil, id: nil, fields_: nil, raw: nil)
