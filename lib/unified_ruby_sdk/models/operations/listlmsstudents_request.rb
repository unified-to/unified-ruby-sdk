  ...
  module Models
    module Operations
      ...
      class ListLmsStudentsRequest
        ...
        def initialize(connection_id:, class_id: nil, course_id: nil, fields_: nil, limit: nil, location_id: nil, offset: nil, order: nil, query: nil, raw: nil, sort: nil, updated_gte: nil)
