  ...
  module Models
    module Operations
      ...
      class CreateMetadataMetadataRequest
        ...
        sig { params(connection_id: ::String, metadata_metadata: Models::Shared::MetadataMetadata, fields_: T.nilable(T::Array[::String]), raw: T.nilable(::String)).void }
        def initialize(connection_id: nil, metadata_metadata: nil, fields_: nil, raw: nil)
