  ...
  module Models
    module Operations
      ...
      class CreateRepoPullrequestRequest
        ...
        sig { params(connection_id: ::String, repo_pullrequest: Models::Shared::RepoPullrequest, fields_: T.nilable(T::Array[::String]), raw: T.nilable(::String)).void }
        def initialize(connection_id: nil, repo_pullrequest: nil, fields_: nil, raw: nil)
