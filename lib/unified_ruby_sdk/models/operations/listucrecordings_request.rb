  ...
  module Models
    module Operations
      ...
      class ListUcRecordingsRequest
        ...
        def initialize(connection_id:, call_id: nil, contact_id: nil, end_le: nil, end_lt: nil, fields_: nil, limit: nil, offset: nil, order: nil, query: nil, raw: nil, sort: nil, start_gte: nil, updated_gte: nil, user_id: nil)
