  ...
  module Models
    module Operations
      ...
      class ListHrisDeductions2Request
        ...
        field :benefit_id, Crystalline::Nilable.new(::String), { 'query_param': { 'field_name': 'benefit_id', 'style': 'form', 'explode': true } }
        ...
        # Fields to return
        field :fields_, Crystalline::Nilable.new(Crystalline::Array.new(Models::Operations::ListHrisDeductions2QueryParamFields)), { 'query_param': { 'field_name': 'fields', 'style': 'form', 'explode': true } }
        ...
        field :payslip_id, Crystalline::Nilable.new(::String), { 'query_param': { 'field_name': 'payslip_id', 'style': 'form', 'explode': true } }
        ...
        sig { params(connection_id: ::String, benefit_id: T.nilable(::String), company_id: T.nilable(::String), end_lt: T.nilable(::String), fields_: T.nilable(T::Array[Models::Operations::ListHrisDeductions2QueryParamFields]), limit: T.nilable(::Float), offset: T.nilable(::Float), order: T.nilable(::String), payslip_id: T.nilable(::String), query: T.nilable(::String), raw: T.nilable(::String), sort: T.nilable(::String), start_gte: T.nilable(::String), updated_gte: T.nilable(::String), user_id: T.nilable(::String)).void }
        def initialize(connection_id:, benefit_id: nil, company_id: nil, end_lt: nil, fields_: nil, limit: nil, offset: nil, order: nil, payslip_id: nil, query: nil, raw: nil, sort: nil, start_gte: nil, updated_gte: nil, user_id: nil)
        ...
        def ==(other)
          ...
          return false unless @payslip_id == other.payslip_id
