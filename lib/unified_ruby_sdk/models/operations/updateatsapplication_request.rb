  ...
  module Models
    module Operations
      ...
      class UpdateAtsApplicationRequest
        ...
        sig { params(ats_application: Models::Shared::AtsApplication, connection_id: ::String, id: ::String, fields_: T.nilable(T::Array[::String]), raw: T.nilable(::String)).void }
        def initialize(ats_application: nil, connection_id: nil, id: nil, fields_: nil, raw: nil)
