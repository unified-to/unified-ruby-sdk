  ...
  module Models
    module Operations
      ...
      class ListLmsActivities2Request
        ...
        field :content_id, Crystalline::Nilable.new(::String), { 'query_param': { 'field_name': 'content_id', 'style': 'form', 'explode': true } }
        ...
        # Fields to return
        field :fields_, Crystalline::Nilable.new(Crystalline::Array.new(Models::Operations::ListLmsActivities2QueryParamFields)), { 'query_param': { 'field_name': 'fields', 'style': 'form', 'explode': true } }
        ...
        field :student_id, Crystalline::Nilable.new(::String), { 'query_param': { 'field_name': 'student_id', 'style': 'form', 'explode': true } }
        ...
        sig { params(connection_id: ::String, content_id: T.nilable(::String), course_id: T.nilable(::String), fields_: T.nilable(T::Array[Models::Operations::ListLmsActivities2QueryParamFields]), limit: T.nilable(::Float), offset: T.nilable(::Float), order: T.nilable(::String), query: T.nilable(::String), raw: T.nilable(::String), sort: T.nilable(::String), student_id: T.nilable(::String), updated_gte: T.nilable(::String)).void }
        def initialize(connection_id:, content_id: nil, course_id: nil, fields_: nil, limit: nil, offset: nil, order: nil, query: nil, raw: nil, sort: nil, student_id: nil, updated_gte: nil)
