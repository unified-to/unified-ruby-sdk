  ...
  module Models
    module Operations
      ...
      class ListKmsPagesRequest
        ...
        sig { params(connection_id: ::String, fields_: T.nilable(T::Array[::String]), limit: T.nilable(::Float), offset: T.nilable(::Float), order: T.nilable(::String), parent_id: T.nilable(::String), query: T.nilable(::String), raw: T.nilable(::String), sort: T.nilable(::String), space_id: T.nilable(::String), updated_gte: T.nilable(::String)).void }
