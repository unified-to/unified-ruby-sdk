  ...
  module Models
    module Operations
      ...
      class UpdateCrmLeadRequest
        ...
        sig { params(connection_id: ::String, crm_lead: Models::Shared::CrmLead, id: ::String, fields_: T.nilable(T::Array[::String]), raw: T.nilable(::String)).void }
        def initialize(connection_id: nil, crm_lead: nil, id: nil, fields_: nil, raw: nil)
