  ...
  module Models
    module Operations
      ...
      class ListMessagingMessages2Request
        ...
        # Fields to return
        field :fields_, Crystalline::Nilable.new(Crystalline::Array.new(Models::Operations::ListMessagingMessages2QueryParamFields)), { 'query_param': { 'field_name': 'fields', 'style': 'form', 'explode': true } }
        ...
        sig { params(connection_id: ::String, channel_id: T.nilable(::String), end_lt: T.nilable(::String), expand: T.nilable(T::Boolean), fields_: T.nilable(T::Array[Models::Operations::ListMessagingMessages2QueryParamFields]), limit: T.nilable(::Float), offset: T.nilable(::Float), order: T.nilable(::String), parent_id: T.nilable(::String), query: T.nilable(::String), raw: T.nilable(::String), sort: T.nilable(::String), start_gte: T.nilable(::String), type: T.nilable(::String), updated_gte: T.nilable(::String), user_id: T.nilable(::String), user_mentioned_id: T.nilable(::String)).void }
        def initialize(connection_id:, channel_id: nil, end_lt: nil, expand: nil, fields_: nil, limit: nil, offset: nil, order: nil, parent_id: nil, query: nil, raw: nil, sort: nil, start_gte: nil, type: nil, updated_gte: nil, user_id: nil, user_mentioned_id: nil)
