  ...
  module Models
    module Operations
      ...
      class ListVerificationRequests2Request
        ...
        # Fields to return
        field :fields_, Crystalline::Nilable.new(Crystalline::Array.new(Models::Operations::ListVerificationRequests2QueryParamFields)), { 'query_param': { 'field_name': 'fields', 'style': 'form', 'explode': true } }
        ...
        field :package_id, Crystalline::Nilable.new(::String), { 'query_param': { 'field_name': 'package_id', 'style': 'form', 'explode': true } }
        ...
        sig { params(connection_id: ::String, candidate_id: T.nilable(::String), fields_: T.nilable(T::Array[Models::Operations::ListVerificationRequests2QueryParamFields]), limit: T.nilable(::Float), offset: T.nilable(::Float), order: T.nilable(::String), package_id: T.nilable(::String), query: T.nilable(::String), raw: T.nilable(::String), sort: T.nilable(::String), updated_gte: T.nilable(::String)).void }
        def initialize(connection_id:, candidate_id: nil, fields_: nil, limit: nil, offset: nil, order: nil, package_id: nil, query: nil, raw: nil, sort: nil, updated_gte: nil)
