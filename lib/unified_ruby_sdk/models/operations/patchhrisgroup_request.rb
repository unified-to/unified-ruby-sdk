  ...
  module Models
    module Operations
      ...
      class PatchHrisGroupRequest
        ...
        sig { params(connection_id: ::String, hris_group: Models::Shared::HrisGroup, id: ::String, fields_: T.nilable(T::Array[::String]), raw: T.nilable(::String)).void }
        def initialize(connection_id: nil, hris_group: nil, id: nil, fields_: nil, raw: nil)
