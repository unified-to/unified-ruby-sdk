  ...
  module Models
    module Operations
      ...
      class UpdateAccountingTransactionRequest
        ...
        sig { params(accounting_transaction: Models::Shared::AccountingTransaction, connection_id: ::String, id: ::String, fields_: T.nilable(T::Array[::String]), raw: T.nilable(::String)).void }
        def initialize(accounting_transaction: nil, connection_id: nil, id: nil, fields_: nil, raw: nil)
