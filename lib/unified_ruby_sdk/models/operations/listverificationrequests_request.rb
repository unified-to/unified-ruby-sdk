  ...
  module Models
    module Operations
      ...
      class ListVerificationRequestsRequest
        ...
        sig { params(connection_id: ::String, candidate_id: T.nilable(::String), fields_: T.nilable(T::Array[::String]), limit: T.nilable(::Float), offset: T.nilable(::Float), order: T.nilable(::String), package_id: T.nilable(::String), query: T.nilable(::String), raw: T.nilable(::String), sort: T.nilable(::String), updated_gte: T.nilable(::String)).void }
