  ...
  module Models
    module Operations
      ...
      class PatchPassthroughJsonRequest
        ...
        field :request_body, Crystalline::Nilable.new(::Object), { 'request': { 'media_type': 'application/json' } }
        ...
        sig { params(connection_id: ::String, path: ::String, request_body: T.nilable(::Object), query: T.nilable(T::Hash[Symbol, ::Object])).void }
