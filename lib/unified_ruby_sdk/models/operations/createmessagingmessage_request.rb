  ...
  module Models
    module Operations
      ...
      class CreateMessagingMessageRequest
        ...
        sig { params(connection_id: ::String, messaging_message: Models::Shared::MessagingMessage, fields_: T.nilable(T::Array[::String]), raw: T.nilable(::String)).void }
        def initialize(connection_id: nil, messaging_message: nil, fields_: nil, raw: nil)
