...
module UnifiedRubySDK
  module Operations
    ...
    class CreatePaymentSubscriptionRequest < ::UnifiedRubySDK::Utils::FieldAugmented
      ...
      sig { params(connection_id: ::String, fields_: T.nilable(T::Array[::String]), payment_subscription: T.nilable(::UnifiedRubySDK::Shared::PaymentSubscription)).void }
      def initialize(connection_id: nil, fields_: nil, payment_subscription: nil)
