  ...
  module Models
    module Operations
      ...
      class PatchCommerceItemvariantRequest
        ...
        # Fields to return
        field :fields_, Crystalline::Nilable.new(Crystalline::Array.new(Models::Operations::PatchCommerceItemvariantQueryParamFields)), { 'query_param': { 'field_name': 'fields', 'style': 'form', 'explode': true } }
