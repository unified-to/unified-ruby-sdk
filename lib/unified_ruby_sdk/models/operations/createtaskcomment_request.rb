  ...
  module Models
    module Operations
      ...
      class CreateTaskCommentRequest
        ...
        sig { params(connection_id: ::String, task_comment: Models::Shared::TaskComment, fields_: T.nilable(T::Array[::String]), raw: T.nilable(::String)).void }
        def initialize(connection_id: nil, task_comment: nil, fields_: nil, raw: nil)
