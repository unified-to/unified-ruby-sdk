  ...
  module Models
    module Operations
      ...
      class ListPaymentLinksRequest
        ...
        sig { params(connection_id: ::String, contact_id: T.nilable(::String), fields_: T.nilable(T::Array[::String]), limit: T.nilable(::Float), offset: T.nilable(::Float), order: T.nilable(::String), payment_id: T.nilable(::String), query: T.nilable(::String), sort: T.nilable(::String), updated_gte: T.nilable(::DateTime)).void }
        def initialize(connection_id: nil, contact_id: nil, fields_: nil, limit: nil, offset: nil, order: nil, payment_id: nil, query: nil, sort: nil, updated_gte: nil)
