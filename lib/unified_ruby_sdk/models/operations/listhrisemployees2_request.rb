  ...
  module Models
    module Operations
      ...
      class ListHrisEmployees2Request
        ...
        # Fields to return
        field :fields_, Crystalline::Nilable.new(Crystalline::Array.new(Models::Operations::ListHrisEmployees2QueryParamFields)), { 'query_param': { 'field_name': 'fields', 'style': 'form', 'explode': true } }
        ...
        sig { params(connection_id: ::String, company_id: T.nilable(::String), fields_: T.nilable(T::Array[Models::Operations::ListHrisEmployees2QueryParamFields]), group_id: T.nilable(::String), limit: T.nilable(::Float), location_id: T.nilable(::String), offset: T.nilable(::Float), order: T.nilable(::String), query: T.nilable(::String), raw: T.nilable(::String), sort: T.nilable(::String), updated_gte: T.nilable(::String)).void }
        def initialize(connection_id:, company_id: nil, fields_: nil, group_id: nil, limit: nil, location_id: nil, offset: nil, order: nil, query: nil, raw: nil, sort: nil, updated_gte: nil)
