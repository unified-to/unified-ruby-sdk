  ...
  module Models
    module Operations
      ...
      class ListRepoOrganizations2Request
        ...
        # Fields to return
        field :fields_, Crystalline::Nilable.new(Crystalline::Array.new(Models::Operations::ListRepoOrganizations2QueryParamFields)), { 'query_param': { 'field_name': 'fields', 'style': 'form', 'explode': true } }
        ...
        sig { params(connection_id: ::String, fields_: T.nilable(T::Array[Models::Operations::ListRepoOrganizations2QueryParamFields]), limit: T.nilable(::Float), offset: T.nilable(::Float), order: T.nilable(::String), query: T.nilable(::String), raw: T.nilable(::String), sort: T.nilable(::String), updated_gte: T.nilable(::String)).void }
