  ...
  module Models
    module Operations
      ...
      class ListShippingLabels2Request
        ...
        # Fields to return
        field :fields_, Crystalline::Nilable.new(Crystalline::Array.new(Models::Operations::ListShippingLabels2QueryParamFields)), { 'query_param': { 'field_name': 'fields', 'style': 'form', 'explode': true } }
        ...
        field :shipment_id, Crystalline::Nilable.new(::String), { 'query_param': { 'field_name': 'shipment_id', 'style': 'form', 'explode': true } }
        ...
        sig { params(connection_id: ::String, fields_: T.nilable(T::Array[Models::Operations::ListShippingLabels2QueryParamFields]), limit: T.nilable(::Float), offset: T.nilable(::Float), order: T.nilable(::String), query: T.nilable(::String), raw: T.nilable(::String), shipment_id: T.nilable(::String), sort: T.nilable(::String), updated_gte: T.nilable(::String)).void }
        def initialize(connection_id:, fields_: nil, limit: nil, offset: nil, order: nil, query: nil, raw: nil, shipment_id: nil, sort: nil, updated_gte: nil)
