...
module UnifiedRubySDK
  module Operations
    ...
    class ListMessagingMessagesRequest < ::UnifiedRubySDK::Utils::FieldAugmented
      ...
      sig { params(connection_id: ::String, channel_id: T.nilable(::String), fields_: T.nilable(T::Array[::String]), limit: T.nilable(::Float), offset: T.nilable(::Float), parent_id: T.nilable(::String), query: T.nilable(::String), updated_gte: T.nilable(::DateTime)).void }
      def initialize(connection_id: nil, channel_id: nil, fields_: nil, limit: nil, offset: nil, parent_id: nil, query: nil, updated_gte: nil)
