  ...
  module Models
    module Operations
      ...
      class ListCalendarEventsRequest
        ...
        field :expand_recurring_events, Crystalline::Nilable.new(::String), { 'query_param': { 'field_name': 'expand_recurring_events', 'style': 'form', 'explode': true } }
        ...
        def initialize(connection_id:, calendar_id: nil, end_le: nil, expand_recurring_events: nil, fields_: nil, limit: nil, offset: nil, order: nil, query: nil, raw: nil, sort: nil, start_gte: nil, updated_gte: nil)
