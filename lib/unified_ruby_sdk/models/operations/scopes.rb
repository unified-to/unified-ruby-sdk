  ...
  module Operations
    ...
    class Scopes < T::Enum
      enums do
        ...
        ACCOUNTING_REFUND_READ = new('accounting_refund_read')
        ACCOUNTING_REFUND_WRITE = new('accounting_refund_write')
        ACCOUNTING_PAYOUT_READ = new('accounting_payout_read')
        ACCOUNTING_PAYOUT_WRITE = new('accounting_payout_write')
