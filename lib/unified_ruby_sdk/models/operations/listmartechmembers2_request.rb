  ...
  module Models
    module Operations
      ...
      class ListMartechMembers2Request
        ...
        # Fields to return
        field :fields_, Crystalline::Nilable.new(Crystalline::Array.new(Models::Operations::ListMartechMembers2QueryParamFields)), { 'query_param': { 'field_name': 'fields', 'style': 'form', 'explode': true } }
        ...
        sig { params(connection_id: ::String, fields_: T.nilable(T::Array[Models::Operations::ListMartechMembers2QueryParamFields]), limit: T.nilable(::Float), list_id: T.nilable(::String), offset: T.nilable(::Float), order: T.nilable(::String), query: T.nilable(::String), raw: T.nilable(::String), sort: T.nilable(::String), updated_gte: T.nilable(::String)).void }
        def initialize(connection_id:, fields_: nil, limit: nil, list_id: nil, offset: nil, order: nil, query: nil, raw: nil, sort: nil, updated_gte: nil)
