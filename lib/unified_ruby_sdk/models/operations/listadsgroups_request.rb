  ...
  module Models
    module Operations
      ...
      class ListAdsGroupsRequest
        ...
        def initialize(connection_id:, campaign_id: nil, fields_: nil, limit: nil, offset: nil, order: nil, org_id: nil, parent_id: nil, query: nil, raw: nil, sort: nil, updated_gte: nil)
