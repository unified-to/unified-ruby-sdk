  ...
  module Models
    module Operations
      ...
      class UpdateAccountingAccountRequest
        ...
        sig { params(accounting_account: Models::Shared::AccountingAccount, connection_id: ::String, id: ::String, fields_: T.nilable(T::Array[::String]), raw: T.nilable(::String)).void }
        def initialize(accounting_account: nil, connection_id: nil, id: nil, fields_: nil, raw: nil)
