  ...
  module Models
    module Operations
      ...
      class CreateUcContactRequest
        ...
        sig { params(connection_id: ::String, uc_contact: Models::Shared::UcContact, fields_: T.nilable(T::Array[::String]), raw: T.nilable(::String)).void }
        def initialize(connection_id: nil, uc_contact: nil, fields_: nil, raw: nil)
