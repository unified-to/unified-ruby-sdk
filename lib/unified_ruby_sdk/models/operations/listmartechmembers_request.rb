  ...
  module Models
    module Operations
      ...
      class ListMartechMembersRequest
        ...
        sig { params(connection_id: ::String, fields_: T.nilable(T::Array[::String]), limit: T.nilable(::Float), list_id: T.nilable(::String), offset: T.nilable(::Float), order: T.nilable(::String), query: T.nilable(::String), raw: T.nilable(::String), sort: T.nilable(::String), updated_gte: T.nilable(::DateTime)).void }
        def initialize(connection_id: nil, fields_: nil, limit: nil, list_id: nil, offset: nil, order: nil, query: nil, raw: nil, sort: nil, updated_gte: nil)
