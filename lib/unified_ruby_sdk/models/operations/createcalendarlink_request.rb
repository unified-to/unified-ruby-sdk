  ...
  module Models
    module Operations
      ...
      class CreateCalendarLinkRequest
        ...
        sig { params(calendar_link: Models::Shared::CalendarLink, connection_id: ::String, fields_: T.nilable(T::Array[::String]), raw: T.nilable(::String)).void }
        def initialize(calendar_link: nil, connection_id: nil, fields_: nil, raw: nil)
