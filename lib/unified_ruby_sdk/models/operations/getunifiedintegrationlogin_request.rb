  ...
  module Models
    module Operations
      ...
      class GetUnifiedIntegrationLoginRequest
        ...
        field :failure_redirect, Crystalline::Nilable.new(::String), { 'query_param': { 'field_name': 'failure_redirect', 'style': 'form', 'explode': true } }
        ...
        def initialize(integration_type:, workspace_id:, env: nil, failure_redirect: nil, redirect: nil, state: nil, success_redirect: nil)
        ...
        def ==(other)
          ...
          return false unless @success_redirect == other.success_redirect
          true
        end
      end
    end
