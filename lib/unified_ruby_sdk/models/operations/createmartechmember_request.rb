  ...
  module Models
    module Operations
      ...
      class CreateMartechMemberRequest
        ...
        sig { params(connection_id: ::String, marketing_member: Models::Shared::MarketingMember, fields_: T.nilable(T::Array[::String]), raw: T.nilable(::String)).void }
        def initialize(connection_id: nil, marketing_member: nil, fields_: nil, raw: nil)
