  ...
  module Models
    module Operations
      ...
      class ListAnalyticsEventsRequest
        ...
        # Fields to return
        field :fields_, Crystalline::Nilable.new(Crystalline::Array.new(Models::Operations::ListAnalyticsEventsQueryParamFields)), { 'query_param': { 'field_name': 'fields', 'style': 'form', 'explode': true } }
        ...
        field :session_id, Crystalline::Nilable.new(::String), { 'query_param': { 'field_name': 'session_id', 'style': 'form', 'explode': true } }
        ...
        sig { params(connection_id: ::String, end_lt: T.nilable(::String), fields_: T.nilable(T::Array[Models::Operations::ListAnalyticsEventsQueryParamFields]), limit: T.nilable(::Float), offset: T.nilable(::Float), order: T.nilable(::String), property_id: T.nilable(::String), query: T.nilable(::String), raw: T.nilable(::String), session_id: T.nilable(::String), sort: T.nilable(::String), start_gte: T.nilable(::String), type: T.nilable(::String), updated_gte: T.nilable(::String), visitor_id: T.nilable(::String)).void }
        def initialize(connection_id:, end_lt: nil, fields_: nil, limit: nil, offset: nil, order: nil, property_id: nil, query: nil, raw: nil, session_id: nil, sort: nil, start_gte: nil, type: nil, updated_gte: nil, visitor_id: nil)
