...
module UnifiedRubySDK
  module Operations
    ...
    class CreateAtsApplicationRequest < ::UnifiedRubySDK::Utils::FieldAugmented
      ...
      sig { params(connection_id: ::String, ats_application: T.nilable(::UnifiedRubySDK::Shared::AtsApplication), fields_: T.nilable(T::Array[::String])).void }
      def initialize(connection_id: nil, ats_application: nil, fields_: nil)
