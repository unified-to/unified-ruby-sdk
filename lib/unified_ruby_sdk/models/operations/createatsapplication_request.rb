  ...
  module Models
    module Operations
      ...
      class CreateAtsApplicationRequest
        ...
        sig { params(ats_application: Models::Shared::AtsApplication, connection_id: ::String, fields_: T.nilable(T::Array[::String]), raw: T.nilable(::String)).void }
        def initialize(ats_application: nil, connection_id: nil, fields_: nil, raw: nil)
