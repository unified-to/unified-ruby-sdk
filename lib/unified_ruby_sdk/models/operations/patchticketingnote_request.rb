  ...
  module Models
    module Operations
      ...
      class PatchTicketingNoteRequest
        ...
        sig { params(connection_id: ::String, id: ::String, ticketing_note: Models::Shared::TicketingNote, fields_: T.nilable(T::Array[::String]), raw: T.nilable(::String)).void }
        def initialize(connection_id: nil, id: nil, ticketing_note: nil, fields_: nil, raw: nil)
