  ...
  module Models
    module Operations
      ...
      class ListPerformanceGoalsRequest
        ...
        field :cycle_id, Crystalline::Nilable.new(::String), { 'query_param': { 'field_name': 'cycle_id', 'style': 'form', 'explode': true } }
        # Fields to return
        field :fields_, Crystalline::Nilable.new(Crystalline::Array.new(Models::Operations::ListPerformanceGoalsQueryParamFields)), { 'query_param': { 'field_name': 'fields', 'style': 'form', 'explode': true } }
        ...
        sig { params(connection_id: ::String, cycle_id: T.nilable(::String), fields_: T.nilable(T::Array[Models::Operations::ListPerformanceGoalsQueryParamFields]), limit: T.nilable(::Float), offset: T.nilable(::Float), order: T.nilable(::String), parent_id: T.nilable(::String), query: T.nilable(::String), raw: T.nilable(::String), sort: T.nilable(::String), type: T.nilable(::String), updated_gte: T.nilable(::String), user_id: T.nilable(::String)).void }
        def initialize(connection_id:, cycle_id: nil, fields_: nil, limit: nil, offset: nil, order: nil, parent_id: nil, query: nil, raw: nil, sort: nil, type: nil, updated_gte: nil, user_id: nil)
