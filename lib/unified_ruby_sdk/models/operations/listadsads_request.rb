  ...
  module Models
    module Operations
      ...
      class ListAdsAdsRequest
        ...
        def initialize(connection_id:, campaign_id: nil, fields_: nil, group_id: nil, limit: nil, offset: nil, order: nil, org_id: nil, query: nil, raw: nil, sort: nil, updated_gte: nil)
