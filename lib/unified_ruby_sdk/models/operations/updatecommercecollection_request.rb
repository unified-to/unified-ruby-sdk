  ...
  module Models
    module Operations
      ...
      class UpdateCommerceCollectionRequest
        ...
        sig { params(commerce_collection: Models::Shared::CommerceCollection, connection_id: ::String, id: ::String, fields_: T.nilable(T::Array[::String]), raw: T.nilable(::String)).void }
        def initialize(commerce_collection: nil, connection_id: nil, id: nil, fields_: nil, raw: nil)
