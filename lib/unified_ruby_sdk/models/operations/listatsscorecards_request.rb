  ...
  module Models
    module Operations
      ...
      class ListAtsScorecardsRequest
        ...
        def initialize(connection_id: nil, application_id: nil, candidate_id: nil, fields_: nil, interview_id: nil, job_id: nil, limit: nil, offset: nil, order: nil, query: nil, raw: nil, sort: nil, updated_gte: nil)
