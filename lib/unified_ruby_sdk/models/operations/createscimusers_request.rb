...
module UnifiedRubySDK
  module Operations
    ...
    class CreateScimUsersRequest < ::UnifiedRubySDK::Utils::FieldAugmented
      ...
      sig { params(connection_id: ::String, count: T.nilable(::Float), filter: T.nilable(::String), sort_by: T.nilable(::String), sort_order: T.nilable(::String), start_index: T.nilable(::Float), user: T.nilable(::UnifiedRubySDK::Shared::User)).void }
      def initialize(connection_id: nil, count: nil, filter: nil, sort_by: nil, sort_order: nil, start_index: nil, user: nil)
