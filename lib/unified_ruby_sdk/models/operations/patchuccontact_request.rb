  ...
  module Models
    module Operations
      ...
      class PatchUcContactRequest
        ...
        sig { params(connection_id: ::String, id: ::String, uc_contact: Models::Shared::UcContact, fields_: T.nilable(T::Array[::String]), raw: T.nilable(::String)).void }
        def initialize(connection_id: nil, id: nil, uc_contact: nil, fields_: nil, raw: nil)
