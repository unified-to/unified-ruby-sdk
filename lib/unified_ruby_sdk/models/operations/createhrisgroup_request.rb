  ...
  module Models
    module Operations
      ...
      class CreateHrisGroupRequest
        ...
        sig { params(connection_id: ::String, hris_group: Models::Shared::HrisGroup, fields_: T.nilable(T::Array[::String]), raw: T.nilable(::String)).void }
        def initialize(connection_id: nil, hris_group: nil, fields_: nil, raw: nil)
