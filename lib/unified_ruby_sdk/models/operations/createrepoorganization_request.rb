  ...
  module Models
    module Operations
      ...
      class CreateRepoOrganizationRequest
        ...
        sig { params(connection_id: ::String, repo_organization: Models::Shared::RepoOrganization, fields_: T.nilable(T::Array[::String]), raw: T.nilable(::String)).void }
        def initialize(connection_id: nil, repo_organization: nil, fields_: nil, raw: nil)
