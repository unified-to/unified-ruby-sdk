  ...
  module Models
    module Operations
      ...
      class CreateCrmPipelineRequest
        ...
        sig { params(connection_id: ::String, crm_pipeline: Models::Shared::CrmPipeline, fields_: T.nilable(T::Array[::String]), raw: T.nilable(::String)).void }
        def initialize(connection_id: nil, crm_pipeline: nil, fields_: nil, raw: nil)
