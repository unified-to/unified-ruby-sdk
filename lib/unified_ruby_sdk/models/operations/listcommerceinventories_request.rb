...
module UnifiedRubySDK
  module Operations
    ...
    class ListCommerceInventoriesRequest < ::UnifiedRubySDK::Utils::FieldAugmented
      ...
      sig { params(connection_id: ::String, fields_: T.nilable(T::Array[::String]), item_id: T.nilable(::String), limit: T.nilable(::Float), location_id: T.nilable(::String), offset: T.nilable(::Float), order: T.nilable(::String), query: T.nilable(::String), sort: T.nilable(::String), updated_gte: T.nilable(::DateTime)).void }
      def initialize(connection_id: nil, fields_: nil, item_id: nil, limit: nil, location_id: nil, offset: nil, order: nil, query: nil, sort: nil, updated_gte: nil)
