...
module UnifiedRubySDK
  module Shared
    ...
    autoload :Group, 'unified_ruby_sdk/models/shared/group.rb'
    autoload :PropertyGroupSchemas, 'unified_ruby_sdk/models/shared/property_group_schemas.rb'
    autoload :ResourceType, 'unified_ruby_sdk/models/shared/resourcetype.rb'
    autoload :PropertyGroupMeta, 'unified_ruby_sdk/models/shared/property_group_meta.rb'
    autoload :Operation, 'unified_ruby_sdk/models/shared/operation.rb'
    autoload :UndefinedType, 'unified_ruby_sdk/models/shared/undefined_type.rb'
    ...
    autoload :User, 'unified_ruby_sdk/models/shared/user.rb'
    autoload :PropertyUserUrnIetfParamsScimSchemasExtensionPeakon20UserGender, 'unified_ruby_sdk/models/shared/property_user_urn_ietf_params_scim_schemas_extension_peakon_2_0_user_gender.rb'
    autoload :PropertyUserUrnIetfParamsScimSchemasExtensionPeakon20User, 'unified_ruby_sdk/models/shared/property_user_urn_ietf_params_scim_schemas_extension_peakon_2_0_user.rb'
    autoload :Ethnicity, 'unified_ruby_sdk/models/shared/ethnicity.rb'
    autoload :PropertyUserUrnIetfParamsScimSchemasExtensionLatticeAttributes10UserGender, 'unified_ruby_sdk/models/shared/property_user_urn_ietf_params_scim_schemas_extension_lattice_attributes_1_0_user_gender.rb'
    autoload :SexualOrientation, 'unified_ruby_sdk/models/shared/sexualorientation.rb'
    autoload :PropertyUserUrnIetfParamsScimSchemasExtensionLatticeAttributes10User, 'unified_ruby_sdk/models/shared/property_user_urn_ietf_params_scim_schemas_extension_lattice_attributes_1_0_user.rb'
    autoload :PropertyUserUrnIetfParamsScimSchemasExtensionEnterprise20UserGender, 'unified_ruby_sdk/models/shared/property_user_urn_ietf_params_scim_schemas_extension_enterprise_2_0_user_gender.rb'
    autoload :Level, 'unified_ruby_sdk/models/shared/level.rb'
    autoload :PropertyUserUrnIetfParamsScimSchemasExtensionEnterprise20User, 'unified_ruby_sdk/models/shared/property_user_urn_ietf_params_scim_schemas_extension_enterprise_2_0_user.rb'
    autoload :PropertyPropertyUserUrnIetfParamsScimSchemasExtensionEnterprise20UserManagerType, 'unified_ruby_sdk/models/shared/property_property_user_urn_ietf_params_scim_schemas_extension_enterprise_2_0_user_manager_type.rb'
    autoload :PropertyPropertyUserUrnIetfParamsScimSchemasExtensionEnterprise20UserManager, 'unified_ruby_sdk/models/shared/property_property_user_urn_ietf_params_scim_schemas_extension_enterprise_2_0_user_manager.rb'
    autoload :PropertyUserSchemas, 'unified_ruby_sdk/models/shared/property_user_schemas.rb'
    autoload :PropertyUserName, 'unified_ruby_sdk/models/shared/property_user_name.rb'
    autoload :PropertyUserMetaResourceType, 'unified_ruby_sdk/models/shared/property_user_meta_resourcetype.rb'
    autoload :PropertyUserMeta, 'unified_ruby_sdk/models/shared/property_user_meta.rb'
