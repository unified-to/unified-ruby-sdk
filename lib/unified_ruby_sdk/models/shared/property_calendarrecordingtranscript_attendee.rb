  ...
  module Models
    module Shared
      ...
      class PropertyCalendarRecordingTranscriptAttendee
        ...
        field :status, Crystalline::Nilable.new(Models::Shared::PropertyCalendarRecordingTranscriptAttendeeStatus), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('status'), 'decoder': Utils.enum_from_string(Models::Shared::PropertyCalendarRecordingTranscriptAttendeeStatus, true) } }

        field :user_id, Crystalline::Nilable.new(::String), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('user_id') } }

        sig { params(email: T.nilable(::String), is_cohost: T.nilable(T::Boolean), name: T.nilable(::String), required: T.nilable(T::Boolean), status: T.nilable(Models::Shared::PropertyCalendarRecordingTranscriptAttendeeStatus), user_id: T.nilable(::String)).void }
