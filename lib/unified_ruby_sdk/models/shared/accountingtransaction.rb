...
module UnifiedRubySDK
  module Shared
    ...
    class AccountingTransaction < ::UnifiedRubySDK::Utils::FieldAugmented
      ...
      field :reference_object, T.nilable(T::Hash[Symbol, ::Object]), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('reference_object') } }
      ...
      sig { params(account_id: T.nilable(::String), contact_id: T.nilable(::String), created_at: T.nilable(::DateTime), currency: T.nilable(::String), customer_message: T.nilable(::String), id: T.nilable(::String), memo: T.nilable(::String), payment_method: T.nilable(::String), payment_terms: T.nilable(::String), raw: T.nilable(T::Hash[Symbol, ::Object]), reference: T.nilable(::String), reference_object: T.nilable(T::Hash[Symbol, ::Object]), split_account_id: T.nilable(::String), sub_total_amount: T.nilable(::Float), tax_amount: T.nilable(::Float), total_amount: T.nilable(::Float), type: T.nilable(::String), updated_at: T.nilable(::DateTime)).void }
      def initialize(account_id: nil, contact_id: nil, created_at: nil, currency: nil, customer_message: nil, id: nil, memo: nil, payment_method: nil, payment_terms: nil, raw: nil, reference: nil, reference_object: nil, split_account_id: nil, sub_total_amount: nil, tax_amount: nil, total_amount: nil, type: nil, updated_at: nil)
