  ...
  module Models
    module Shared
      ...
      class CommerceCollection
        ...
        field :tags, T.nilable(T::Array[Models::Shared::PropertyCommerceCollectionTags]), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('tags') } }
        ...
        sig { params(name: ::String, created_at: T.nilable(::DateTime), description: T.nilable(::String), id: T.nilable(::String), is_active: T.nilable(T::Boolean), is_featured: T.nilable(T::Boolean), is_visible: T.nilable(T::Boolean), media: T.nilable(T::Array[Models::Shared::CommerceItemMedia]), metadata: T.nilable(T::Array[Models::Shared::CommerceMetadata]), parent_id: T.nilable(::String), public_description: T.nilable(::String), public_name: T.nilable(::String), raw: T.nilable(T::Hash[Symbol, ::Object]), tags: T.nilable(T::Array[Models::Shared::PropertyCommerceCollectionTags]), type: T.nilable(Models::Shared::CommerceCollectionType), updated_at: T.nilable(::DateTime)).void }
