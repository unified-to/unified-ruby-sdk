...
module UnifiedRubySDK
  module Shared
    ...
    class KmsPage < ::UnifiedRubySDK::Utils::FieldAugmented
      ...
      sig { params(download_url: ::String, title: ::String, type: ::UnifiedRubySDK::Shared::KmsPageType, created_at: T.nilable(::DateTime), has_children: T.nilable(T::Boolean), id: T.nilable(::String), is_active: T.nilable(T::Boolean), metadata: T.nilable(T::Array[::UnifiedRubySDK::Shared::KmsPageMetadata]), parent_page_id: T.nilable(::String), raw: T.nilable(T::Hash[Symbol, ::Object]), space_id: T.nilable(::String), updated_at: T.nilable(::DateTime), user_id: T.nilable(::String), web_url: T.nilable(::String)).void }
      def initialize(download_url: nil, title: nil, type: nil, created_at: nil, has_children: nil, id: nil, is_active: nil, metadata: nil, parent_page_id: nil, raw: nil, space_id: nil, updated_at: nil, user_id: nil, web_url: nil)
