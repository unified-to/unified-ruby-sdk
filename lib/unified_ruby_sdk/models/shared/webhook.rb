...
module UnifiedRubySDK
  module Shared
    ...
    class Webhook < ::UnifiedRubySDK::Utils::FieldAugmented
      ...
      sig { params(connection_id: ::String, event: ::UnifiedRubySDK::Shared::Event, hook_url: ::String, interval: ::Float, object_type: ::UnifiedRubySDK::Shared::ObjectType, checked_at: T.nilable(::DateTime), created_at: T.nilable(::DateTime), environment: T.nilable(::String), fields: T.nilable(::String), id: T.nilable(::String), integration_type: T.nilable(::String), is_healthy: T.nilable(T::Boolean), meta: T.nilable(T::Hash[Symbol, ::Object]), runs: T.nilable(T::Array[::String]), updated_at: T.nilable(::DateTime), webhook_type: T.nilable(::UnifiedRubySDK::Shared::WebhookWebhookType), workspace_id: T.nilable(::String)).void }
