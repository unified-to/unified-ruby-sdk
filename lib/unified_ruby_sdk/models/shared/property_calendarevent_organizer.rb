  ...
  module Models
    module Shared
      ...
      class PropertyCalendarEventOrganizer
        ...
        field :status, Crystalline::Nilable.new(Models::Shared::PropertyCalendarEventOrganizerStatus), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('status'), 'decoder': Utils.enum_from_string(Models::Shared::PropertyCalendarEventOrganizerStatus, true) } }
