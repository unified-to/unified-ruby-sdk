  ...
  module Models
    module Shared
      ...
      class PropertyAdsReportMetricsCampaignTargetingGeographic
        ...
        sig { params(cities: T.nilable(T::Array[Models::Shared::CityTarget]), countries: T.nilable(T::Array[Models::Shared::GeoTarget]), excluded_cities: T.nilable(T::Array[Models::Shared::CityTarget]), excluded_countries: T.nilable(T::Array[Models::Shared::GeoTarget]), excluded_postal_codes: T.nilable(T::Array[Models::Shared::GeoTarget]), excluded_regions: T.nilable(T::Array[Models::Shared::RegionTarget]), excluded_us_dmas: T.nilable(T::Array[Models::Shared::GeoTarget]), location_types: T.nilable(T::Array[Models::Shared::PropertyAdsReportMetricsCampaignTargetingGeographicLocationTypes]), postal_codes: T.nilable(T::Array[Models::Shared::GeoTarget]), presence_type: T.nilable(Models::Shared::PropertyAdsReportMetricsCampaignTargetingGeographicPresenceType), regions: T.nilable(T::Array[Models::Shared::RegionTarget]), us_dmas: T.nilable(T::Array[Models::Shared::GeoTarget])).void }
