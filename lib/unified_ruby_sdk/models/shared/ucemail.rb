  ...
  module Models
    module Shared
      ...
      class UcEmail
        ...
        field :type, Crystalline::Nilable.new(Models::Shared::UcEmailType), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('type'), 'decoder': Utils.enum_from_string(Models::Shared::UcEmailType, true) } }
