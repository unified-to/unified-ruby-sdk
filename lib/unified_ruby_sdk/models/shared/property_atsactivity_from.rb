  ...
  module Models
    module Shared
      ...
      class PropertyAtsActivityFrom
        ...
        field :type, Crystalline::Nilable.new(Models::Shared::PropertyAtsActivityFromType), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('type'), 'decoder': Utils.enum_from_string(Models::Shared::PropertyAtsActivityFromType, true) } }
