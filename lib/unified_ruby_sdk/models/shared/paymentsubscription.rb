  ...
  module Models
    module Shared
      ...
      class PaymentSubscription
        ...
        field :interval_unit, T.nilable(Models::Shared::IntervalUnit), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('interval_unit'), 'decoder': Utils.enum_from_string(Models::Shared::IntervalUnit, true) } }
        ...
        field :status, T.nilable(Models::Shared::PaymentSubscriptionStatus), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('status'), 'decoder': Utils.enum_from_string(Models::Shared::PaymentSubscriptionStatus, true) } }
