  ...
  module Models
    module Shared
      ...
      class CrmMetadata
        ...
        sig { params(extra_data: T.nilable(T.any(T::Hash[Symbol, ::Object], ::String, ::Float, T::Boolean, T::Array[T.any(Models::Shared::CrmMetadata1, ::String, ::Float, T::Boolean)])), format: T.nilable(Models::Shared::CrmMetadataFormat), id: T.nilable(::String), namespace: T.nilable(::String), slug: T.nilable(::String), value: T.nilable(T.any(T::Hash[Symbol, ::Object], ::String, ::Float, T::Boolean, T::Array[T.any(Models::Shared::CrmMetadataSchemas1, ::String, ::Float, T::Boolean)]))).void }
