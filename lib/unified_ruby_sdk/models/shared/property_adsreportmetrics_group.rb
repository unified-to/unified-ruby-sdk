  ...
  module Models
    module Shared
      ...
      class PropertyAdsReportMetricsGroup
        ...
        sig { params(campaign_id: T.nilable(::String), created_at: T.nilable(::DateTime), id: T.nilable(::String), is_active: T.nilable(T::Boolean), name: T.nilable(::String), organization_id: T.nilable(::String), raw: T.nilable(T::Hash[Symbol, ::Object]), targeting: T.nilable(Models::Shared::PropertyAdsReportMetricsGroupTargeting), updated_at: T.nilable(::DateTime)).void }
