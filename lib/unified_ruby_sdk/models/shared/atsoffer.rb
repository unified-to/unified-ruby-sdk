  ...
  module Models
    module Shared
      ...
      class AtsOffer
        ...
        field :status, Crystalline::Nilable.new(Models::Shared::AtsOfferStatus), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('status'), 'decoder': Utils.enum_from_string(Models::Shared::AtsOfferStatus, true) } }
