  ...
  module Models
    module Shared
      ...
      class AdsAd
        ...
        sig { params(ad_copy: T.nilable(::String), ad_type: T.nilable(Models::Shared::AdType), campaign_id: T.nilable(::String), created_at: T.nilable(::DateTime), creative_asset_url: T.nilable(::String), cta: T.nilable(::String), description: T.nilable(::String), final_url: T.nilable(::String), group_id: T.nilable(::String), headline: T.nilable(::String), id: T.nilable(::String), is_active: T.nilable(T::Boolean), name: T.nilable(::String), organization_id: T.nilable(::String), raw: T.nilable(T::Hash[Symbol, ::Object]), targeting: T.nilable(Models::Shared::PropertyAdsAdTargeting), updated_at: T.nilable(::DateTime)).void }
