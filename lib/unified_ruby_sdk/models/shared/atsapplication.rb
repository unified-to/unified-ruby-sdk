...
module UnifiedRubySDK
  module Shared
    ...
    class AtsApplication < ::UnifiedRubySDK::Utils::FieldAugmented
      ...
      sig { params(answers: T.nilable(T::Array[::UnifiedRubySDK::Shared::AtsApplicationAnswer]), applied_at: T.nilable(::DateTime), candidate_id: T.nilable(::String), created_at: T.nilable(::DateTime), hired_at: T.nilable(::DateTime), id: T.nilable(::String), job_id: T.nilable(::String), offers: T.nilable(T::Array[::UnifiedRubySDK::Shared::AtsOffer]), original_status: T.nilable(::String), raw: T.nilable(::UnifiedRubySDK::Shared::AtsApplicationRaw), rejected_at: T.nilable(::DateTime), rejected_reason: T.nilable(::String), source: T.nilable(::String), status: T.nilable(::UnifiedRubySDK::Shared::AtsApplicationStatus), updated_at: T.nilable(::DateTime)).void }
