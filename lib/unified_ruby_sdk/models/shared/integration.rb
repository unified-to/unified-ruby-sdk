  ...
  module Models
    module Shared
      ...
      class Integration
        ...
        field :api, T.nilable(T.any(Models::Shared::Integration1, T.any(::String, Models::Shared::IntegrationSchemasApi22), T.any(::Float, Models::Shared::IntegrationSchemasApi32), T.any(T::Boolean, Models::Shared::IntegrationSchemasApi2), T.any(T::Array[::Object], Models::Shared::IntegrationSchemasApi52))), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('api') } }
        ...
        field :partnership, T.nilable(T.any(Models::Shared::IntegrationSchemas1, T.any(::String, Models::Shared::IntegrationSchemasPartnership2), T.any(::Float, Models::Shared::IntegrationSchemasPartnership32), T.any(T::Boolean, Models::Shared::IntegrationSchemasPartnership42), T.any(T::Array[::Object], Models::Shared::IntegrationSchemasPartnership52))), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('partnership') } }
        ...
        field :sandbox, T.nilable(T.any(Models::Shared::IntegrationSchemasSandbox1, T.any(::String, Models::Shared::IntegrationSchemasSandbox22), T.any(::Float, Models::Shared::IntegrationSchemasSandbox32), T.any(T::Boolean, Models::Shared::IntegrationSchemasSandbox42), T.any(T::Array[::Object], Models::Shared::IntegrationSchemasSandbox52))), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('sandbox') } }
        ...
        field :token_instructions, T.nilable(T::Array[Models::Shared::PropertyIntegrationTokenInstructions]), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('token_instructions') } }
        # if auth_types = 'token'
        ...
        sig { params(categories: T::Array[Models::Shared::PropertyIntegrationCategories], name: ::String, type: ::String, active_healthy_connections: T.nilable(::Float), api: T.nilable(T.any(Models::Shared::Integration1, T.any(::String, Models::Shared::IntegrationSchemasApi22), T.any(::Float, Models::Shared::IntegrationSchemasApi32), T.any(T::Boolean, Models::Shared::IntegrationSchemasApi2), T.any(T::Array[::Object], Models::Shared::IntegrationSchemasApi52))), api_docs_url: T.nilable(::String), beta: T.nilable(T::Boolean), color: T.nilable(::String), created_at: T.nilable(::String), description: T.nilable(::String), fa_icon: T.nilable(::String), featured: T.nilable(T::Boolean), in_progress: T.nilable(T::Boolean), is_active: T.nilable(T::Boolean), logo_url: T.nilable(::String), partnership: T.nilable(T.any(Models::Shared::IntegrationSchemas1, T.any(::String, Models::Shared::IntegrationSchemasPartnership2), T.any(::Float, Models::Shared::IntegrationSchemasPartnership32), T.any(T::Boolean, Models::Shared::IntegrationSchemasPartnership42), T.any(T::Array[::Object], Models::Shared::IntegrationSchemasPartnership52))), popularity: T.nilable(::Float), rate_limit_description: T.nilable(::String), sandbox: T.nilable(T.any(Models::Shared::IntegrationSchemasSandbox1, T.any(::String, Models::Shared::IntegrationSchemasSandbox22), T.any(::Float, Models::Shared::IntegrationSchemasSandbox32), T.any(T::Boolean, Models::Shared::IntegrationSchemasSandbox42), T.any(T::Array[::Object], Models::Shared::IntegrationSchemasSandbox52))), support: T.nilable(T::Hash[Symbol, ::Object]), tested_at: T.nilable(::DateTime), text_color: T.nilable(::String), token_instructions: T.nilable(T::Array[Models::Shared::PropertyIntegrationTokenInstructions]), token_names: T.nilable(T::Array[::String]), updated_at: T.nilable(::String), web_url: T.nilable(::String)).void }
