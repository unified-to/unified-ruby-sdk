...
module UnifiedRubySDK
  module Shared
    ...
    class HrisMetadata < ::Crystalline::FieldAugmented
      ...
      sig { params(key: ::String, extra_data: T.nilable(::UnifiedRubySDK::Shared::HrisMetadataExtraData), id: T.nilable(::String), namespace: T.nilable(::String), type: T.nilable(::String), value: T.nilable(::UnifiedRubySDK::Shared::HrisMetadataValue)).void }
