  ...
  module Models
    module Shared
      ...
      class CommerceReviewComment
        ...
        field :status, T.nilable(Models::Shared::CommerceReviewCommentStatus), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('status'), 'decoder': Utils.enum_from_string(Models::Shared::CommerceReviewCommentStatus, true) } }
        ...
        def initialize(content: nil, author_avatar_url: nil, author_email: nil, author_location: nil, author_name: nil, created_at: nil, helpful_votes: nil, id: nil, is_public: nil, is_verified: nil, metadata: nil, raw: nil, status: nil, unhelpful_votes: nil, updated_at: nil)
          @content = content
