  ...
  module Models
    module Shared
      ...
      class AccountingPurchaseorder
        ...
        sig { params(account_id: T.nilable(::String), billing_address: T.nilable(Models::Shared::PropertyAccountingPurchaseorderBillingAddress), contact_id: T.nilable(::String), created_at: T.nilable(::DateTime), currency: T.nilable(::String), id: T.nilable(::String), lineitems: T.nilable(T::Array[Models::Shared::AccountingLineitem]), posted_at: T.nilable(::DateTime), raw: T.nilable(T::Hash[Symbol, ::Object]), shipping_address: T.nilable(Models::Shared::PropertyAccountingPurchaseorderShippingAddress), status: T.nilable(Models::Shared::AccountingPurchaseorderStatus), total_amount: T.nilable(::Float), updated_at: T.nilable(::DateTime)).void }
