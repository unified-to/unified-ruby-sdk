  ...
  module Models
    module Shared
      ...
      class AccountingPurchaseorder
        ...
        field :billing_address, T.nilable(Models::Shared::PropertyAccountingPurchaseorderBillingAddress), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('billing_address') } }
        ...
        field :shipping_address, T.nilable(Models::Shared::PropertyAccountingPurchaseorderShippingAddress), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('shipping_address') } }

        field :status, T.nilable(Models::Shared::AccountingPurchaseorderStatus), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('status'), 'decoder': Utils.enum_from_string(Models::Shared::AccountingPurchaseorderStatus, true) } }
