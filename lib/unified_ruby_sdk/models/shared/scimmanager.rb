...
module UnifiedRubySDK
  module Shared
    ...
    class ScimManager < ::Crystalline::FieldAugmented
      ...
      field :type, T.nilable(::UnifiedRubySDK::Shared::ScimManagerType), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('type'), 'decoder': Utils.enum_from_string(::UnifiedRubySDK::Shared::ScimManagerType, true) } }

      field :value, T.nilable(::String), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('value') } }


      sig { params(dollar_ref: T.nilable(::String), display_name: T.nilable(::String), manager_id: T.nilable(::String), type: T.nilable(::UnifiedRubySDK::Shared::ScimManagerType), value: T.nilable(::String)).void }
