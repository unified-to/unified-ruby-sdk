  ...
  module Models
    module Shared
      ...
      class AccountingCreditmemo
        ...
        field :creditmemo_number, T.nilable(::String), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('creditmemo_number') } }
        ...
        field :payment_collection_method, T.nilable(Models::Shared::AccountingCreditmemoPaymentCollectionMethod), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('payment_collection_method'), 'decoder': Utils.enum_from_string(Models::Shared::AccountingCreditmemoPaymentCollectionMethod, true) } }
        ...
        field :status, T.nilable(Models::Shared::AccountingCreditmemoStatus), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('status'), 'decoder': Utils.enum_from_string(Models::Shared::AccountingCreditmemoStatus, true) } }
