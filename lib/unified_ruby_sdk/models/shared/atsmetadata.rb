  ...
  module Models
    module Shared
      ...
      class AtsMetadata
        ...
        field :extra_data, T.nilable(Models::Shared::ExtraData), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('extra_data') } }
        ...
        field :value, T.nilable(Models::Shared::Value), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('value') } }


        sig { params(extra_data: T.nilable(Models::Shared::ExtraData), id: T.nilable(::String), key: T.nilable(::String), namespace: T.nilable(::String), slug: T.nilable(::String), type: T.nilable(::String), value: T.nilable(Models::Shared::Value)).void }
