...
module UnifiedRubySDK
  module Shared
    ...
    class AtsMetadata < ::Crystalline::FieldAugmented
      extend T::Sig
      ...
      sig { params(extra_data: T.nilable(::UnifiedRubySDK::Shared::ExtraData), id: T.nilable(::String), key: T.nilable(::String), namespace: T.nilable(::String), slug: T.nilable(::String), type: T.nilable(::String), value: T.nilable(::UnifiedRubySDK::Shared::Value)).void }
