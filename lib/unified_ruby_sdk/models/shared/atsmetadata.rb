  ...
  module Models
    module Shared
      ...
      class AtsMetadata
        ...
        field :format, Crystalline::Nilable.new(Models::Shared::AtsMetadataFormat), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('format'), 'decoder': Utils.enum_from_string(Models::Shared::AtsMetadataFormat, true) } }
        ...
        sig { params(extra_data: T.nilable(T.any(T::Hash[Symbol, ::Object], ::String, ::Float, T::Boolean, T::Array[T.any(Models::Shared::AtsMetadata1, ::String, ::Float, T::Boolean)])), format: T.nilable(Models::Shared::AtsMetadataFormat), id: T.nilable(::String), namespace: T.nilable(::String), slug: T.nilable(::String), value: T.nilable(T.any(T::Hash[Symbol, ::Object], ::String, ::Float, T::Boolean, T::Array[T.any(Models::Shared::AtsMetadataSchemas1, ::String, ::Float, T::Boolean)]))).void }
