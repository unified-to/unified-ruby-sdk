...
module UnifiedRubySDK
  module Shared
    ...
    class ScimPhoneNumber < ::UnifiedRubySDK::Utils::FieldAugmented
      ...
      field :type, T.nilable(::UnifiedRubySDK::Shared::ScimPhoneNumberType), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('type'), 'decoder': Utils.enum_from_string(::UnifiedRubySDK::Shared::ScimPhoneNumberType, true) } }

      field :value, T.nilable(::String), { 'format_json': { 'letter_case': ::UnifiedRubySDK::Utils.field_name('value') } }


      sig { params(display: T.nilable(::String), primary: T.nilable(T::Boolean), type: T.nilable(::UnifiedRubySDK::Shared::ScimPhoneNumberType), value: T.nilable(::String)).void }
