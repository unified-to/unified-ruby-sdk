  ...
  module Models
    module Shared
      ...
      class AdsGroup
        ...
        sig { params(bid_amount: T.nilable(::Float), bid_strategy: T.nilable(Models::Shared::PropertyAdsGroupBidStrategy), billing_event: T.nilable(Models::Shared::BillingEvent), budget_allocation_type: T.nilable(Models::Shared::BudgetAllocationType), budget_amount: T.nilable(::Float), budget_max_amount: T.nilable(::Float), budget_period: T.nilable(Models::Shared::AdsGroupBudgetPeriod), budget_unit: T.nilable(Models::Shared::BudgetUnit), campaign_id: T.nilable(::String), created_at: T.nilable(::DateTime), creative_ids: T.nilable(T::Array[::String]), currency: T.nilable(::String), effective_status: T.nilable(Models::Shared::AdsGroupEffectiveStatus), end_at: T.nilable(::DateTime), frequency_cap: T.nilable(Models::Shared::PropertyAdsGroupFrequencyCap), has_eu_political_ads: T.nilable(T::Boolean), id: T.nilable(::String), insertionorder_id: T.nilable(::String), name: T.nilable(::String), optimization_goal: T.nilable(Models::Shared::OptimizationGoal), organization_id: T.nilable(::String), pacing: T.nilable(Models::Shared::PropertyAdsGroupPacing), parent_id: T.nilable(::String), promoted: T.nilable(T::Array[Models::Shared::AdsPromoted]), raw: T.nilable(T::Hash[Symbol, ::Object]), start_at: T.nilable(::DateTime), status: T.nilable(Models::Shared::AdsGroupStatus), targeting: T.nilable(Models::Shared::PropertyAdsGroupTargeting), type: T.nilable(Models::Shared::AdsGroupType), updated_at: T.nilable(::DateTime)).void }
