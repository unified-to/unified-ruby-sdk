...
module UnifiedRubySDK
  ...
  class Metadata
    ...
    def create_metadata_metadata(metadata_metadata, connection_id, fields_ = nil, timeout_ms = nil)
      ...
      query_params = Utils.get_query_params(Models::Operations::CreateMetadataMetadataRequest, request)
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(http_response.env.response_body), Models::Shared::MetadataMetadata)
          response = Models::Operations::CreateMetadataMetadataResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            metadata_metadata: obj
          )
    ...
    def get_metadata_metadata(connection_id, id, fields_ = nil, timeout_ms = nil)
      ...
      headers = {}
      query_params = Utils.get_query_params(Models::Operations::GetMetadataMetadataRequest, request)
      headers['Accept'] = 'application/json'
      headers['user-agent'] = @sdk_configuration.user_agent
    ...
    def list_metadata_metadatas(request, timeout_ms = nil)
      ...
      headers = {}
      query_params = Utils.get_query_params(Models::Operations::ListMetadataMetadatasRequest, request)
      headers['Accept'] = 'application/json'
      headers['user-agent'] = @sdk_configuration.user_agent
      ...
      if Utils.match_status_code(http_response.status, ['200'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(http_response.env.response_body), T::Array[Models::Shared::MetadataMetadata])
          response = Models::Operations::ListMetadataMetadatasResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            metadata_metadatas: obj
          )
    ...
    def patch_metadata_metadata(metadata_metadata, connection_id, id, fields_ = nil, timeout_ms = nil)
      ...
      query_params = Utils.get_query_params(Models::Operations::PatchMetadataMetadataRequest, request)
      headers['Accept'] = 'application/json'
      headers['user-agent'] = @sdk_configuration.user_agent
    ...
    def update_metadata_metadata(metadata_metadata, connection_id, id, fields_ = nil, timeout_ms = nil)
      ...
      query_params = Utils.get_query_params(Models::Operations::UpdateMetadataMetadataRequest, request)
      headers['Accept'] = 'application/json'
      headers['user-agent'] = @sdk_configuration.user_agent
