...
module UnifiedRubySDK
  ...
  class UnifiedTo
    ...
    def init_sdks
      ...
      @paymentterm = Paymentterm.new(@sdk_configuration)
      ...
      @notification = Notification.new(@sdk_configuration)
