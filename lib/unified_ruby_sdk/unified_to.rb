...
module UnifiedRubySDK
  ...
  class UnifiedTo
    ...
    attr_accessor :accounting, :account, :agedpayable, :agedreceivable, :balancesheet, :bankfeedaccount, :bankfeedtransaction, :bill, :cashflow, :category, :contact, :creditmemo, :expense, :invoice, :journal, :order, :organization, :profitloss, :project, :purchaseorder, :quote, :report, :salesorder, :taxrate, :transaction, :trialbalance, :vendorcredit, :ads, :ad, :asset, :campaign, :creative, :group, :insertionorder, :promoted, :target, :analytics, :event, :property, :session, :visitor, :assessment, :package, :ats, :activity, :application, :applicationstatus, :candidate, :company, :document, :interview, :job, :scorecard, :calendar, :busy, :link, :recording, :webinar, :cdp, :activation, :destination, :profile, :segment, :source, :clubs, :location, :member, :commerce, :availability, :collection, :inventory, :item, :itemvariant, :reservation, :review, :saleschannel, :crm, :deal, :lead, :picklist, :pipeline, :datastore, :database, :query, :record, :table, :enrich, :person, :forms, :form, :submission, :genai, :embedding, :model, :prompt, :hris, :attendance, :bankaccount, :benefit, :deduction, :device, :employee, :payslip, :taxonomy, :timeoff, :timeshift, :kms, :comment, :page, :space, :lms, :class_, :content, :course, :instructor, :student, :martech, :list, :messaging, :channel, :message, :metadata, :passthrough, :payment, :payout, :refund, :subscription, :performance, :cycle, :feedback, :goal, :repo, :branch, :commit, :pullrequest, :repository, :scim, :user, :shipping, :carrier, :label, :rate, :shipment, :tracking, :signing, :signatory, :template, :storage, :file, :task, :change, :ticketing, :customer, :note, :ticket, :uc, :call, :unified, :apicall, :connection, :environment, :integration, :auth, :login, :saml, :issue, :webhook, :secretsmanager, :verification, :request
    ...
    def init_sdks
      ...
      @agedpayable = Agedpayable.new(@sdk_configuration)
      @agedreceivable = Agedreceivable.new(@sdk_configuration)
      @balancesheet = Balancesheet.new(@sdk_configuration)
      @bankfeedaccount = Bankfeedaccount.new(@sdk_configuration)
      @bankfeedtransaction = Bankfeedtransaction.new(@sdk_configuration)
      ...
      @quote = Quote.new(@sdk_configuration)
      ...
      @vendorcredit = Vendorcredit.new(@sdk_configuration)
      ...
      @promoted = Promoted.new(@sdk_configuration)
      @target = Target.new(@sdk_configuration)
      @analytics = Analytics.new(@sdk_configuration)
      @event = Event.new(@sdk_configuration)
      @property = Property.new(@sdk_configuration)
      @session = Session.new(@sdk_configuration)
      @visitor = Visitor.new(@sdk_configuration)
      ...
      @cdp = Cdp.new(@sdk_configuration)
      @activation = Activation.new(@sdk_configuration)
      @destination = Destination.new(@sdk_configuration)
      @profile = Profile.new(@sdk_configuration)
      @segment = Segment.new(@sdk_configuration)
      @source = Source.new(@sdk_configuration)
      ...
      @picklist = Picklist.new(@sdk_configuration)
      @pipeline = Pipeline.new(@sdk_configuration)
      @datastore = Datastore.new(@sdk_configuration)
      @database = Database.new(@sdk_configuration)
      @query = Query.new(@sdk_configuration)
      @record = Record.new(@sdk_configuration)
      @table = Table.new(@sdk_configuration)
      ...
      @taxonomy = Taxonomy.new(@sdk_configuration)
      ...
      @content = Content.new(@sdk_configuration)
      ...
      @performance = Performance.new(@sdk_configuration)
      @cycle = Cycle.new(@sdk_configuration)
      @feedback = Feedback.new(@sdk_configuration)
      @goal = Goal.new(@sdk_configuration)
      ...
      @signing = Signing.new(@sdk_configuration)
      @signatory = Signatory.new(@sdk_configuration)
      @template = Template.new(@sdk_configuration)
      ...
      @saml = Saml.new(@sdk_configuration)
      @issue = Issue.new(@sdk_configuration)
      @webhook = Webhook.new(@sdk_configuration)
      @secretsmanager = Secretsmanager.new(@sdk_configuration)
