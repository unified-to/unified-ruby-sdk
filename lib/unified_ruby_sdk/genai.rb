...
module UnifiedRubySDK
  ...
  class Genai
    ...
    def create_genai_prompt(genai_prompt, connection_id, fields_ = nil)
      ...
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Crystalline.unmarshal_json(JSON.parse(r.env.response_body), ::UnifiedRubySDK::Shared::GenaiPrompt)
    ...
    def list_genai_models(request)
      ...
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Crystalline.unmarshal_json(JSON.parse(r.env.response_body), T::Array[::UnifiedRubySDK::Shared::GenaiModel])
