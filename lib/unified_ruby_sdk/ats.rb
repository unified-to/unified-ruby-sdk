...
module UnifiedRubySDK
  ...
  class Ats
    ...
    sig { params(request: T.nilable(Models::Operations::ListAtsActivitiesRequest), timeout_ms: T.nilable(Integer)).returns(Models::Operations::ListAtsActivitiesResponse) }
