...
module UnifiedRubySDK
  ...
  class Scim
    ...
    sig { params(connection_id: ::String, group: T.nilable(::UnifiedRubySDK::Shared::Group)).returns(::UnifiedRubySDK::Operations::CreateScimGroupsResponse) }
    def create_scim_groups(connection_id, group = nil)
      ...
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::UnifiedRubySDK::Shared::Group)
          res.group = out
        end
      end
      res
    ...
    def create_scim_users(request)
      ...
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::UnifiedRubySDK::Shared::User)
          res.user = out
        end
      end
      res
    ...
    def list_scim_groups(request)
      ...
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, T::Array[::UnifiedRubySDK::Shared::Group])
          res.groups = out
        end
      end
      res
    ...
    def list_scim_users(request)
      ...
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, T::Array[::UnifiedRubySDK::Shared::User])
          res.users = out
        end
      end
      res
    ...
    sig { params(connection_id: ::String, id: ::String, group: T.nilable(::UnifiedRubySDK::Shared::Group)).returns(::UnifiedRubySDK::Operations::PatchScimGroupsResponse) }
    def patch_scim_groups(connection_id, id, group = nil)
    ...
    sig { params(connection_id: ::String, id: ::String, user: T.nilable(::UnifiedRubySDK::Shared::User)).returns(::UnifiedRubySDK::Operations::PatchScimUsersResponse) }
    def patch_scim_users(connection_id, id, user = nil)
    ...
    sig { params(connection_id: ::String, id: ::String, group: T.nilable(::UnifiedRubySDK::Shared::Group)).returns(::UnifiedRubySDK::Operations::UpdateScimGroupsResponse) }
    def update_scim_groups(connection_id, id, group = nil)
    ...
    sig { params(connection_id: ::String, id: ::String, user: T.nilable(::UnifiedRubySDK::Shared::User)).returns(::UnifiedRubySDK::Operations::UpdateScimUsersResponse) }
    def update_scim_users(connection_id, id, user = nil)
