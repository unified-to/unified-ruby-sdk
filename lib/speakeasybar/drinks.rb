...
module OpenApiSDK
  ...
  class Drinks
    ...
    sig { params(request: T.nilable(Operations::GetDrinkRequest)).returns(Utils::FieldAugmented) }
    ...
    sig { params(request: T.nilable(Operations::ListDrinksRequest)).returns(Utils::FieldAugmented) }
