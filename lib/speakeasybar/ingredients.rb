...
module OpenApiSDK
  ...
  class Ingredients
    ...
    sig { params(ingredients: T.nilable(T::Array[String])).returns(Utils::FieldAugmented) }
    def list_ingredients(ingredients = nil)
      # list_ingredients - Get a list of ingredients.
      # Get a list of ingredients, if authenticated this will include stock levels and product codes otherwise it will only include public information.
      request = Operations::ListIngredientsRequest.new(
