...
| `delivery_instructions` | *T.nilable(::String)*   | :heavy_minus_sign:      | N/A                     |
| `email`                 | *T.nilable(::String)*   | :heavy_minus_sign:      | N/A                     |
| `is_residential`        | *T.nilable(T::Boolean)* | :heavy_minus_sign:      | N/A                     |
| `is_validated`          | *T.nilable(T::Boolean)* | :heavy_minus_sign:      | N/A                     |
