...
res = s.repository.create_repo_repository(connection_id="<id>", repo_repository=::UnifiedRubySDK::Shared::RepoRepository.new(
  name: "<value>",
), fields_=[
  "<value>",
])
...
res = s.repository.patch_repo_repository(connection_id="<id>", id="<id>", repo_repository=::UnifiedRubySDK::Shared::RepoRepository.new(
  name: "<value>",
), fields_=[
  "<value>",
])
...
res = s.repository.update_repo_repository(connection_id="<id>", id="<id>", repo_repository=::UnifiedRubySDK::Shared::RepoRepository.new(
  name: "<value>",
), fields_=[
  "<value>",
])
