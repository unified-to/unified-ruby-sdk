...
res = s.storage.get_storage_file(connection_id="<value>", id="<id>", fields_=[
  "<value>",
])
...
res = s.storage.patch_storage_file(connection_id="<value>", id="<id>", storage_file=::UnifiedRubySDK::Shared::StorageFile.new(), fields_=[
  "<value>",
])
...
res = s.storage.remove_storage_file(connection_id="<value>", id="<id>")
...
res = s.storage.update_storage_file(connection_id="<value>", id="<id>", storage_file=::UnifiedRubySDK::Shared::StorageFile.new(), fields_=[
  "<value>",
])
