...
res = s.message.create_messaging_message(messaging_message=Models::Shared::MessagingMessage.new(), connection_id="<id>", fields_=[
  "<value>",
])
...
res = s.message.patch_messaging_message(messaging_message=Models::Shared::MessagingMessage.new(), connection_id="<id>", id="<id>", fields_=[
  "<value>",
])
...
res = s.message.update_messaging_message(messaging_message=Models::Shared::MessagingMessage.new(), connection_id="<id>", id="<id>", fields_=[
  "<value>",
])
