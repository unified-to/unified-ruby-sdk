...
res = s.job.patch_ats_job(ats_job=Models::Shared::AtsJob.new(), connection_id="<id>", id="<id>", fields_=[
  "<value>",
])
...
res = s.job.update_ats_job(ats_job=Models::Shared::AtsJob.new(), connection_id="<id>", id="<id>", fields_=[
  "<value>",
])
