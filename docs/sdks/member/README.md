...
res = s.member.get_martech_member(connection_id: '<id>', id: '<id>')
...
res = s.member.list_martech_members(request: req)
...
res = s.member.patch_martech_member(request: req)
...
res = s.member.update_martech_member(request: req)
