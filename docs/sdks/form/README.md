...
res = s.form.create_forms_form(forms_form: Models::Shared::FormsForm.new(
  ...
  fields_: [
    Models::Shared::FormField.new(
      ...
      updated_at: DateTime.iso8601('2025-04-12T06:01:46.777Z'),
    ),
    Models::Shared::FormField.new(
      created_at: DateTime.iso8601('2023-10-05T21:34:29.094Z'),
      ...
      order: 1.0,
      type: Models::Shared::FormFieldType::TEXTAREA,
      updated_at: DateTime.iso8601('2024-08-23T14:35:07.850Z'),
    ),
    Models::Shared::FormField.new(
      choices: [
        'vallum',
      ...
      updated_at: DateTime.iso8601('2024-02-22T05:26:37.024Z'),
    ),
    Models::Shared::FormField.new(
      created_at: DateTime.iso8601('2023-10-05T21:34:29.094Z'),
      ...
      order: 3.0,
      type: Models::Shared::FormFieldType::TEXTAREA,
      updated_at: DateTime.iso8601('2024-11-15T09:03:54.561Z'),
    ),
  ],
  ...
  updated_at: DateTime.iso8601('2024-08-15T11:37:19.941Z'),
), connection_id: '<id>')
  ...
  forms_form: Models::Shared::FormsForm.new(
    ...
    fields_: [
      Models::Shared::FormField.new(
        ...
        order: 0.0,
        type: Models::Shared::FormFieldType::TEXTAREA,
        updated_at: DateTime.iso8601('2025-04-12T06:01:46.789Z'),
      ),
      Models::Shared::FormField.new(
        created_at: DateTime.iso8601('2023-10-05T21:34:29.094Z'),
        id: '82b263f9-2d16-4cdf-8e99-d05ba46ce817',
        ...
        order: 1.0,
        type: Models::Shared::FormFieldType::TEXTAREA,
        updated_at: DateTime.iso8601('2024-08-23T14:35:07.857Z'),
      ),
      Models::Shared::FormField.new(
        choices: [
          'vallum',
        ...
        order: 2.0,
        type: Models::Shared::FormFieldType::MULTIPLE_SELECT,
        updated_at: DateTime.iso8601('2024-02-22T05:26:37.027Z'),
      ),
      Models::Shared::FormField.new(
        created_at: DateTime.iso8601('2023-10-05T21:34:29.094Z'),
        description: 'Sequi antea delectatio.',
        ...
        order: 3.0,
        type: Models::Shared::FormFieldType::TEXTAREA,
        updated_at: DateTime.iso8601('2024-11-15T09:03:54.570Z'),
      ),
    ],
    has_multiple_submissions: false,
    has_progress_bar: false,
    ...
    published_url: 'https://impartial-institute.org/',
    response_count: 423.0,
    updated_at: DateTime.iso8601('2024-08-15T11:37:19.947Z'),
  ),
  connection_id: '<id>',
  id: '<id>',
)
