...
res = s.file.patch_storage_file(storage_file=Models::Shared::StorageFile.new(), connection_id="<id>", id="<id>", fields_=[
  "<value>",
])
...
res = s.file.update_storage_file(storage_file=Models::Shared::StorageFile.new(), connection_id="<id>", id="<id>", fields_=[
  "<value>",
])
