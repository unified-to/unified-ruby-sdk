...
res = s.passthrough.create_passthrough_json(connection_id="<value>", path="/opt/lib", request_body="<value>")
...
res = s.passthrough.create_passthrough_raw(connection_id="<value>", path="/etc/namedb", request_body="0x34ABa9b31D".encode())
...
res = s.passthrough.list_passthroughs(connection_id="<value>", path="/selinux")
...
res = s.passthrough.patch_passthrough_json(connection_id="<value>", path="/home/user", request_body="<value>")
...
res = s.passthrough.patch_passthrough_raw(connection_id="<value>", path="/etc/mail", request_body="0x7CEb8f75C6".encode())
...
res = s.passthrough.remove_passthrough(connection_id="<value>", path="/Applications")
...
res = s.passthrough.update_passthrough_json(connection_id="<value>", path="/etc/namedb", request_body="<value>")
...
res = s.passthrough.update_passthrough_raw(connection_id="<value>", path="/System", request_body="0x5587B3b9f8".encode())
