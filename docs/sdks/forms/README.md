...
res = s.forms.create_forms_form(forms_form: Models::Shared::FormsForm.new(
  ...
  fields_: [
    Models::Shared::FormField.new(
      ...
      updated_at: DateTime.iso8601('2025-04-13T06:40:27.582Z'),
    ),
    Models::Shared::FormField.new(
      created_at: DateTime.iso8601('2023-10-05T21:34:29.094Z'),
      ...
      order: 1.0,
      type: Models::Shared::FormFieldType::TEXTAREA,
      updated_at: DateTime.iso8601('2024-08-24T04:55:55.482Z'),
    ),
    Models::Shared::FormField.new(
      choices: [
        'vallum',
      ...
      updated_at: DateTime.iso8601('2024-02-22T11:38:15.626Z'),
    ),
    Models::Shared::FormField.new(
      created_at: DateTime.iso8601('2023-10-05T21:34:29.094Z'),
  ...
  forms_form: Models::Shared::FormsForm.new(
    ...
    fields_: [
      Models::Shared::FormField.new(
        ...
        order: 0.0,
        type: Models::Shared::FormFieldType::TEXTAREA,
        updated_at: DateTime.iso8601('2025-04-13T06:40:27.594Z'),
      ),
      Models::Shared::FormField.new(
        created_at: DateTime.iso8601('2023-10-05T21:34:29.094Z'),
        id: '82b263f9-2d16-4cdf-8e99-d05ba46ce817',
        ...
        order: 1.0,
        type: Models::Shared::FormFieldType::TEXTAREA,
        updated_at: DateTime.iso8601('2024-08-24T04:55:55.489Z'),
      ),
      Models::Shared::FormField.new(
        choices: [
          'vallum',
        ...
        order: 2.0,
        type: Models::Shared::FormFieldType::MULTIPLE_SELECT,
        updated_at: DateTime.iso8601('2024-02-22T11:38:15.629Z'),
      ),
      Models::Shared::FormField.new(
        created_at: DateTime.iso8601('2023-10-05T21:34:29.094Z'),
        description: 'Sequi antea delectatio.',
        ...
        order: 3.0,
        type: Models::Shared::FormFieldType::TEXTAREA,
        updated_at: DateTime.iso8601('2024-11-16T03:08:09.093Z'),
      ),
    ],
    has_multiple_submissions: false,
    has_progress_bar: false,
    has_shuffle_questions: true,
    id: '55f737e0-f585-410f-afbc-f6b7a7074f28',
    is_active: false,
    name: 'voluptatibus omnis audax Form',
    published_url: 'https://impartial-institute.org/',
    response_count: 423.0,
    updated_at: DateTime.iso8601('2024-08-16T01:36:27.466Z'),
  ),
  connection_id: '<id>',
  id: '<id>',
)
