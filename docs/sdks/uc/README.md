...
res = s.uc.create_uc_comment(uc_comment: Models::Shared::UcComment.new(
  ...
  updated_at: '2024-02-02T01:28:06.487Z',
), connection_id: '<id>')
...
res = s.uc.create_uc_contact(uc_contact: Models::Shared::UcContact.new(
  ...
  updated_at: DateTime.iso8601('2023-11-19T13:07:06.442Z'),
), connection_id: '<id>')
...
res = s.uc.create_uc_recording(uc_recording: Models::Shared::UcRecording.new(
  ...
  end_at: DateTime.iso8601('2024-04-22T06:18:10.506Z'),
  expires_at: DateTime.iso8601('2026-03-29T14:13:08.470Z'),
  id: 'f374502d-94ef-4033-ade4-fd0f770e487d',
  media: [],
  start_at: DateTime.iso8601('2023-04-23T00:06:29.151Z'),
  type: Models::Shared::UcRecordingType::INBOUND,
  updated_at: DateTime.iso8601('2025-02-24T23:31:03.744Z'),
...
req = Models::Operations::PatchUcCommentRequest.new(
  uc_comment: Models::Shared::UcComment.new(
    ...
    updated_at: '2024-02-02T01:28:06.488Z',
  ),
  connection_id: '<id>',
  id: '<id>',
)
...
req = Models::Operations::PatchUcContactRequest.new(
  uc_contact: Models::Shared::UcContact.new(
    ...
    title: 'Chief Optimization Executive',
    updated_at: DateTime.iso8601('2023-11-19T13:07:06.447Z'),
  ),
  connection_id: '<id>',
  id: '<id>',
)
...
req = Models::Operations::PatchUcRecordingRequest.new(
  uc_recording: Models::Shared::UcRecording.new(
    contacts: [],
    created_at: DateTime.iso8601('2022-09-17T19:41:46.956Z'),
    end_at: DateTime.iso8601('2024-04-22T06:18:10.512Z'),
    expires_at: DateTime.iso8601('2026-03-29T14:13:08.483Z'),
    id: '0d41fda0-59b5-488b-96f7-a0972b129d71',
    media: [],
    start_at: DateTime.iso8601('2023-04-23T00:06:29.153Z'),
    type: Models::Shared::UcRecordingType::INBOUND,
    updated_at: DateTime.iso8601('2025-02-24T23:31:03.752Z'),
    user_name: 'Melyna Larson',
    user_phone: '1-915-327-0429 x509',
    web_url: 'https://spherical-comparison.org',
  ),
