...
res = s.location.create_commerce_location(connection_id="string", commerce_location=Shared::CommerceLocation.new(
...
res = s.location.patch_commerce_location(connection_id="string", id="string", commerce_location=Shared::CommerceLocation.new(
    address=Shared::PropertyCommerceLocationAddress.new(),
    name="string",
    raw={
      "Kina": "string",
...
res = s.location.update_commerce_location(connection_id="string", id="string", commerce_location=Shared::CommerceLocation.new(
    address=Shared::PropertyCommerceLocationAddress.new(),
    name="string",
    raw={
      "hmph": "string",
