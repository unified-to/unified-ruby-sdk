...
res = s.inventory.create_commerce_inventory2(commerce_inventory: Models::Shared::CommerceInventory.new(), connection_id: '<id>')
...
res = s.inventory.get_commerce_inventory2(connection_id: '<id>', id: '<id>')
...
res = s.inventory.list_commerce_inventories2(request: req)
...
res = s.inventory.patch_commerce_inventory2(request: req)
...
res = s.inventory.remove_commerce_inventory2(connection_id: '<id>', id: '<id>')
...
res = s.inventory.update_commerce_inventory2(request: req)
